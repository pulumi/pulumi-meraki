...
export class LicensingSubscriptionSubscriptionsClaimKeyValidate extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LicensingSubscriptionSubscriptionsClaimKeyValidateState, opts?: pulumi.CustomResourceOptions): LicensingSubscriptionSubscriptionsClaimKeyValidate {
        return new LicensingSubscriptionSubscriptionsClaimKeyValidate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'meraki:administered/licensingSubscriptionSubscriptionsClaimKeyValidate:LicensingSubscriptionSubscriptionsClaimKeyValidate';
     ...
     */
    public static isInstance(obj: any): obj is LicensingSubscriptionSubscriptionsClaimKeyValidate {
    ...
    constructor(name: string, argsOrState?: LicensingSubscriptionSubscriptionsClaimKeyValidateArgs | LicensingSubscriptionSubscriptionsClaimKeyValidateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LicensingSubscriptionSubscriptionsClaimKeyValidate.__pulumiType, name, resourceInputs, opts);
    }
}
