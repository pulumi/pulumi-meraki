 ...
 */
export interface GetSwitchDhcpServerPolicyArpInspectionTrustedServersArgs {
    /**
 ...
 */
export interface GetSwitchDhcpServerPolicyArpInspectionTrustedServersResult {
    /**
     * endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
     */
 ...
 * A collection of arguments for invoking getSwitchDhcpServerPolicyArpInspectionTrustedServers.
 */
export interface GetSwitchDhcpServerPolicyArpInspectionTrustedServersOutputArgs {
    /**
     * endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
     */
