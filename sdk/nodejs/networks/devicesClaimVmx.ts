...
export class DevicesClaimVmx extends pulumi.CustomResource {
    ...
    declare public /*out*/ readonly item: pulumi.Output<outputs.networks.DevicesClaimVmxItem>;
    /**
     * networkId path parameter. Network ID
     */
    declare public readonly networkId: pulumi.Output<string>;
    declare public readonly parameters: pulumi.Output<outputs.networks.DevicesClaimVmxParameters>;
