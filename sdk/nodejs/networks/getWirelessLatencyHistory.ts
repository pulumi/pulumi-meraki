 ...
 */
export interface GetWirelessLatencyHistoryArgs {
    /**
 ...
 */
export interface GetWirelessLatencyHistoryResult {
    /**
     * accessCategory query parameter. Filter by access category.
     */
 ...
 * A collection of arguments for invoking getWirelessLatencyHistory.
 */
export interface GetWirelessLatencyHistoryOutputArgs {
    /**
     * accessCategory query parameter. Filter by access category.
     */
    accessCategory?: pulumi.Input<string | undefined>;
    /**
     * apTag query parameter. Filter results by AP tag.
     */
