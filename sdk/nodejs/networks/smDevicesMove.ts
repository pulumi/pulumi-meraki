 ...
 *
 * const example = new meraki.networks.SmDevicesMove("example", {
 *     networkId: "string",
 *     parameters: {
 *         ids: [
 *             "1284392014819",
 ...
 *     },
 * });
 * export const merakiNetworksSmDevicesMoveExample = example;
 * ```
 */
export class SmDevicesMove extends pulumi.CustomResource {
    ...
    declare public /*out*/ readonly item: pulumi.Output<outputs.networks.SmDevicesMoveItem>;
    /**
     * networkId path parameter. Network ID
     */
    declare public readonly networkId: pulumi.Output<string>;
    declare public readonly parameters: pulumi.Output<outputs.networks.SmDevicesMoveParameters>;
