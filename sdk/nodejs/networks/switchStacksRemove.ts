 ...
 * ```
 */
export class SwitchStacksRemove extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SwitchStacksRemoveState, opts?: pulumi.CustomResourceOptions): SwitchStacksRemove {
        return new SwitchStacksRemove(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'meraki:networks/switchStacksRemove:SwitchStacksRemove';

    /**
     * Returns true if the given object is an instance of SwitchStacksRemove.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SwitchStacksRemove {
     ...
     */
    constructor(name: string, args: SwitchStacksRemoveArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SwitchStacksRemoveArgs | SwitchStacksRemoveState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SwitchStacksRemove.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface SwitchStacksRemoveArgs {
    /**
     * networkId path parameter. Network ID
     */
    networkId: pulumi.Input<string>;
