 ...
 * ```
 */
export function getPiiSmDevicesForKey(args: GetPiiSmDevicesForKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetPiiSmDevicesForKeyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("meraki:networks/getPiiSmDevicesForKey:getPiiSmDevicesForKey", {
 ...
 */
export interface GetPiiSmDevicesForKeyArgs {
    /**
 ...
 */
export interface GetPiiSmDevicesForKeyResult {
    /**
     * bluetoothMac query parameter. The MAC of a Bluetooth client
     */
    ...
    readonly item: outputs.networks.GetPiiSmDevicesForKeyItem;
    /**
     * mac query parameter. The MAC of a network client device or a Systems Manager device
     */
    readonly mac?: string;
 ...
 * ```
 */
export function getPiiSmDevicesForKeyOutput(args: GetPiiSmDevicesForKeyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPiiSmDevicesForKeyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("meraki:networks/getPiiSmDevicesForKey:getPiiSmDevicesForKey", {
        "bluetoothMac": args.bluetoothMac,
        "email": args.email,
        "imei": args.imei,
        "mac": args.mac,
 ...
 * A collection of arguments for invoking getPiiSmDevicesForKey.
 */
export interface GetPiiSmDevicesForKeyOutputArgs {
    /**
     * bluetoothMac query parameter. The MAC of a Bluetooth client
     */
