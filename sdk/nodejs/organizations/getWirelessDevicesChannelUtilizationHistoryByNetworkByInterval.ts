 ...
 * ```
 */
export function getWirelessDevicesChannelUtilizationHistoryByNetworkByInterval(args: GetWirelessDevicesChannelUtilizationHistoryByNetworkByIntervalArgs, opts?: pulumi.InvokeOptions): Promise<GetWirelessDevicesChannelUtilizationHistoryByNetworkByIntervalResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("meraki:organizations/getWirelessDevicesChannelUtilizationHistoryByNetworkByInterval:getWirelessDevicesChannelUtilizationHistoryByNetworkByInterval", {
 ...
 */
export interface GetWirelessDevicesChannelUtilizationHistoryByNetworkByIntervalArgs {
    /**
 ...
 */
export interface GetWirelessDevicesChannelUtilizationHistoryByNetworkByIntervalResult {
    /**
     * endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
     */
     ...
     */
    readonly items: outputs.organizations.GetWirelessDevicesChannelUtilizationHistoryByNetworkByIntervalItem[];
    /**
     * networkIds query parameter. Filter results by network.
     */
...
export function getWirelessDevicesChannelUtilizationHistoryByNetworkByIntervalOutput(args: GetWirelessDevicesChannelUtilizationHistoryByNetworkByIntervalOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetWirelessDevicesChannelUtilizationHistoryByNetworkByIntervalResult> {
    return pulumi.output(args).apply((a: any) => getWirelessDevicesChannelUtilizationHistoryByNetworkByInterval(a, opts))
}

/**
 * A collection of arguments for invoking getWirelessDevicesChannelUtilizationHistoryByNetworkByInterval.
 */
export interface GetWirelessDevicesChannelUtilizationHistoryByNetworkByIntervalOutputArgs {
    /**
     * endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
     */
