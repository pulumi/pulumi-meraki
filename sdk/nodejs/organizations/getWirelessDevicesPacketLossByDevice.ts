 ...
 * ```
 */
export function getWirelessDevicesPacketLossByDevice(args: GetWirelessDevicesPacketLossByDeviceArgs, opts?: pulumi.InvokeOptions): Promise<GetWirelessDevicesPacketLossByDeviceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("meraki:organizations/getWirelessDevicesPacketLossByDevice:getWirelessDevicesPacketLossByDevice", {
        "bands": args.bands,
 ...
 */
export interface GetWirelessDevicesPacketLossByDeviceArgs {
    /**
 ...
 */
export interface GetWirelessDevicesPacketLossByDeviceResult {
    /**
     * bands query parameter. Filter results by band. Valid bands are: 2.4, 5, and 6.
     */
 ...
 * ```
 */
export function getWirelessDevicesPacketLossByDeviceOutput(args: GetWirelessDevicesPacketLossByDeviceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWirelessDevicesPacketLossByDeviceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("meraki:organizations/getWirelessDevicesPacketLossByDevice:getWirelessDevicesPacketLossByDevice", {
        "bands": args.bands,
        "endingBefore": args.endingBefore,
        "networkIds": args.networkIds,
        "organizationId": args.organizationId,
 ...
 * A collection of arguments for invoking getWirelessDevicesPacketLossByDevice.
 */
export interface GetWirelessDevicesPacketLossByDeviceOutputArgs {
    /**
     * bands query parameter. Filter results by band. Valid bands are: 2.4, 5, and 6.
     */
