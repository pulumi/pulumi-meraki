...
func GetDevices(ctx *pulumi.Context, args *GetDevicesArgs, opts ...pulumi.InvokeOption) (*GetDevicesResult, error) {
	...
	err := ctx.Invoke("meraki:index/getDevices:getDevices", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetDevicesOutput(ctx *pulumi.Context, args GetDevicesOutputArgs, opts ...pulumi.InvokeOption) GetDevicesResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetDevicesResultOutput, error) {
			...
			return ctx.InvokeOutput("meraki:index/getDevices:getDevices", args, GetDevicesResultOutput{}, options).(GetDevicesResultOutput), nil
...
func (o GetDevicesResultOutput) Item() GetDevicesItemOutput {
	return o.ApplyT(func(v GetDevicesResult) GetDevicesItem { return v.Item }).(GetDevicesItemOutput)
}
