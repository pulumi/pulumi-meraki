...
//			example, err := networks.NewSmDevicesReboot(ctx, "example", &networks.SmDevicesRebootArgs{
...
//						pulumi.String("test"),
//					},
//					NotifyUser:                   pulumi.Bool(true),
//					RebuildKernelCache:           pulumi.Bool(true),
//					RequestRequiresNetworkTether: pulumi.Bool(true),
