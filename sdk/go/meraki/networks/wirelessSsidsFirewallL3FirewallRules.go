...
//			example, err := networks.NewWirelessSsidsFirewallL3FirewallRules(ctx, "example", &networks.WirelessSsidsFirewallL3FirewallRulesArgs{
//				AllowLanAccess: pulumi.Bool(true),
