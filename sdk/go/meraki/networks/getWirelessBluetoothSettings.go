...
func LookupWirelessBluetoothSettingsOutput(ctx *pulumi.Context, args LookupWirelessBluetoothSettingsOutputArgs, opts ...pulumi.InvokeOption) LookupWirelessBluetoothSettingsResultOutput {
	...
	return ctx.InvokeOutput("meraki:networks/getWirelessBluetoothSettings:getWirelessBluetoothSettings", args, LookupWirelessBluetoothSettingsResultOutput{}, options).(LookupWirelessBluetoothSettingsResultOutput)
}
