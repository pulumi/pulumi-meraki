...
func LookupApplianceSecurityIntrusionOutput(ctx *pulumi.Context, args LookupApplianceSecurityIntrusionOutputArgs, opts ...pulumi.InvokeOption) LookupApplianceSecurityIntrusionResultOutput {
	...
	return ctx.InvokeOutput("meraki:networks/getApplianceSecurityIntrusion:getApplianceSecurityIntrusion", args, LookupApplianceSecurityIntrusionResultOutput{}, options).(LookupApplianceSecurityIntrusionResultOutput)
}
