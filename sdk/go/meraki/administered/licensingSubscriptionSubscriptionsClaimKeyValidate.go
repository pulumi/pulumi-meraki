...
//			example, err := administered.NewLicensingSubscriptionSubscriptionsClaimKeyValidate(ctx, "example", &administered.LicensingSubscriptionSubscriptionsClaimKeyValidateArgs{
