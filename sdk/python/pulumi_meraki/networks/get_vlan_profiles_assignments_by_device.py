...
class GetVlanProfilesAssignmentsByDeviceResult:
    ...
    """
    def __init__(__self__, ending_before=None, items=None, network_id=None, per_page=None, product_types=None, serials=None, stack_ids=None, starting_after=None):
...
def get_vlan_profiles_assignments_by_device_output(ending_before: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                                   ...
                                                   stack_ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
