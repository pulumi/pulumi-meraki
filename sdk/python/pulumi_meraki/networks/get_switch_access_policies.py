...
class GetSwitchAccessPoliciesResult:
    ...
    """
    def __init__(__self__, access_policy_number=None, item=None, items=None, network_id=None):
...
def get_switch_access_policies_output(access_policy_number: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
