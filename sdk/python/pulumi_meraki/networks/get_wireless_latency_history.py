...
def get_wireless_latency_history_output(access_category: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        ap_tag: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
