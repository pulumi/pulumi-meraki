...
class _ApplianceTrafficShapingVpnExclusionsState:
    def __init__(__self__, *,
                 item: pulumi.Input[Optional['ApplianceTrafficShapingVpnExclusionsItemArgs']] = None,
                 network_id: pulumi.Input[Optional[_builtins.str]] = None,
                 parameters: pulumi.Input[Optional['ApplianceTrafficShapingVpnExclusionsParametersArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> pulumi.Input[Optional['ApplianceTrafficShapingVpnExclusionsItemArgs']]:
        return pulumi.get(self, "item")

    @item.setter
    def item(self, value: pulumi.Input[Optional['ApplianceTrafficShapingVpnExclusionsItemArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> pulumi.Input[Optional['ApplianceTrafficShapingVpnExclusionsParametersArgs']]:
        return pulumi.get(self, "parameters")

    @parameters.setter
    def parameters(self, value: pulumi.Input[Optional['ApplianceTrafficShapingVpnExclusionsParametersArgs']]):
        pulumi.set(self, "parameters", value)
