...
class GetSwitchStacksResult:
    ...
    """
    def __init__(__self__, item=None, items=None, network_id=None, switch_stack_id=None):
...
def get_switch_stacks_output(network_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
