...
class GetAppliancePortsResult:
    ...
    """
    def __init__(__self__, item=None, items=None, network_id=None, port_id=None):
...
def get_appliance_ports_output(network_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
