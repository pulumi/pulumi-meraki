...
class GetSmTrustedAccessConfigsResult:
    ...
    """
    def __init__(__self__, ending_before=None, items=None, network_id=None, per_page=None, starting_after=None):
...
def get_sm_trusted_access_configs_output(ending_before: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
