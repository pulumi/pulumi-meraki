...
class GetFloorPlansResult:
    ...
    """
    def __init__(__self__, floor_plan_id=None, item=None, items=None, network_id=None):
...
def get_floor_plans_output(floor_plan_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
