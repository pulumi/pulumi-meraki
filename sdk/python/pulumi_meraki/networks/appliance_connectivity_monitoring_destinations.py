...
class ApplianceConnectivityMonitoringDestinations(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 destinations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ApplianceConnectivityMonitoringDestinationsDestinationArgs', 'ApplianceConnectivityMonitoringDestinationsDestinationArgsDict', 'outputs.ApplianceConnectivityMonitoringDestinationsDestination']]]]] = None,
                 network_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ## Example Usage
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['ApplianceConnectivityMonitoringDestinationsDestinationArgs', 'ApplianceConnectivityMonitoringDestinationsDestinationArgsDict', 'outputs.ApplianceConnectivityMonitoringDestinationsDestination']]]] destinations: The list of connectivity monitoring destinations
        :param pulumi.Input[_builtins.str] network_id: networkId path parameter. Network ID
        """
        ...
    @overload
