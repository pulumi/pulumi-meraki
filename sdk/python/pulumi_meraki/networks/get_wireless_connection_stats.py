...
class GetWirelessConnectionStatsResult:
    ...
    """
    def __init__(__self__, ap_tag=None, band=None, item=None, network_id=None, ssid=None, t0=None, t1=None, timespan=None, vlan=None):
...
def get_wireless_connection_stats_output(ap_tag: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
