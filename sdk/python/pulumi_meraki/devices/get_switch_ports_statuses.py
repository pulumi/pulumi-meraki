...
class GetSwitchPortsStatusesResult:
    ...
    """
    def __init__(__self__, items=None, serial=None, t0=None, timespan=None):
...
def get_switch_ports_statuses_output(serial: pulumi.Input[Optional[_builtins.str]] = None,
