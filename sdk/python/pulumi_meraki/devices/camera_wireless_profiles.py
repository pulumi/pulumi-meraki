...
class CameraWirelessProfiles(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ids: pulumi.Input[Optional[Union['CameraWirelessProfilesIdsArgs', 'CameraWirelessProfilesIdsArgsDict', 'outputs.CameraWirelessProfilesIds']]] = None,
                 serial: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ## Example Usage
        ...
        :param pulumi.Input[Union['CameraWirelessProfilesIdsArgs', 'CameraWirelessProfilesIdsArgsDict', 'outputs.CameraWirelessProfilesIds']] ids: The ids of the wireless profile to assign to the given camera
        :param pulumi.Input[_builtins.str] serial: serial path parameter.
        """
        ...
    @overload
