...
class _LiveToolsPingState:
    def __init__(__self__, *,
                 item: pulumi.Input[Optional['LiveToolsPingItemArgs']] = None,
                 parameters: pulumi.Input[Optional['LiveToolsPingParametersArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> pulumi.Input[Optional['LiveToolsPingItemArgs']]:
        return pulumi.get(self, "item")

    @item.setter
    def item(self, value: pulumi.Input[Optional['LiveToolsPingItemArgs']]):
        pulumi.set(self, "item", value)

    @_builtins.property
    @pulumi.getter
    def parameters(self) -> pulumi.Input[Optional['LiveToolsPingParametersArgs']]:
        return pulumi.get(self, "parameters")

    @parameters.setter
    def parameters(self, value: pulumi.Input[Optional['LiveToolsPingParametersArgs']]):
        pulumi.set(self, "parameters", value)
