...
class GetSmSentryPoliciesAssignmentsByNetworkResult:
    ...
    """
    def __init__(__self__, ending_before=None, items=None, network_ids=None, organization_id=None, per_page=None, starting_after=None):
...
def get_sm_sentry_policies_assignments_by_network_output(ending_before: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
