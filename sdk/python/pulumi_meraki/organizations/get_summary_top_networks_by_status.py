...
class GetSummaryTopNetworksByStatusResult:
    ...
    """
    def __init__(__self__, ending_before=None, items=None, organization_id=None, per_page=None, starting_after=None):
...
def get_summary_top_networks_by_status_output(ending_before: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
