...
class GetSensorReadingsLatestResult:
    ...
    """
    def __init__(__self__, ending_before=None, items=None, metrics=None, network_ids=None, organization_id=None, per_page=None, serials=None, starting_after=None):
...
def get_sensor_readings_latest_output(ending_before: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                      metrics: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
