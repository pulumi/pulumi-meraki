...
class GetWirelessDevicesPacketLossByDeviceResult:
    ...
    """
    def __init__(__self__, bands=None, ending_before=None, items=None, network_ids=None, organization_id=None, per_page=None, serials=None, ssids=None, starting_after=None, t0=None, t1=None, timespan=None):
...
def get_wireless_devices_packet_loss_by_device_output(bands: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                                      ...
                                                      ssids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
