...
class GetApiRequestsOverviewResult:
    ...
    """
    def __init__(__self__, item=None, organization_id=None, t0=None, t1=None, timespan=None):
...
def get_api_requests_overview_output(organization_id: pulumi.Input[Optional[_builtins.str]] = None,
