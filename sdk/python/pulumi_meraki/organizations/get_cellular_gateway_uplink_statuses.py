...
def get_cellular_gateway_uplink_statuses_output(ending_before: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                                iccids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
