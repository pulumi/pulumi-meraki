...
class GetSmAdminsRolesResult:
    ...
    """
    def __init__(__self__, ending_before=None, item=None, organization_id=None, per_page=None, role_id=None, starting_after=None):
...
def get_sm_admins_roles_output(ending_before: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
