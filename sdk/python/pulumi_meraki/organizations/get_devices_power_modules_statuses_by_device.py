...
class GetDevicesPowerModulesStatusesByDeviceResult:
    ...
    """
    def __init__(__self__, ending_before=None, items=None, network_ids=None, organization_id=None, per_page=None, product_types=None, serials=None, starting_after=None, tags=None, tags_filter_type=None):
...
def get_devices_power_modules_statuses_by_device_output(ending_before: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
