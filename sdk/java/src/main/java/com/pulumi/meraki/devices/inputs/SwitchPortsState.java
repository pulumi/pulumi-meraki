...
public final class SwitchPortsState extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="mirror")
    private @Nullable Output<SwitchPortsMirrorArgs> mirror;

    /**
     * @return Port mirror
     * 
     */
    public Optional<Output<SwitchPortsMirrorArgs>> mirror() {
     ...
     */
    @Import(name="module")
    private @Nullable Output<SwitchPortsModuleArgs> module;

    /**
     * @return Expansion module
     * 
     */
    public Optional<Output<SwitchPortsModuleArgs>> module() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder mirror(@Nullable Output<SwitchPortsMirrorArgs> mirror) {
            $.mirror = mirror;
            return this;
        }
         ...
         * 
         */
        public Builder module(@Nullable Output<SwitchPortsModuleArgs> module) {
            $.module = module;
            return this;
        }
