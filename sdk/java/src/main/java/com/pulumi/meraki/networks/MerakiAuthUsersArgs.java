...
public final class MerakiAuthUsersArgs extends com.pulumi.resources.ResourceArgs {

    public static final MerakiAuthUsersArgs Empty = new MerakiAuthUsersArgs();
    ...
    private MerakiAuthUsersArgs() {}

    private MerakiAuthUsersArgs(MerakiAuthUsersArgs $) {
    ...
    public static Builder builder(MerakiAuthUsersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MerakiAuthUsersArgs();
        }

        public Builder(MerakiAuthUsersArgs defaults) {
            $ = new MerakiAuthUsersArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MerakiAuthUsersArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("MerakiAuthUsersArgs", "networkId");
            }
            return $;
        }
    }
