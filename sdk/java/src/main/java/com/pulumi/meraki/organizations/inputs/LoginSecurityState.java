...
public final class LoginSecurityState extends com.pulumi.resources.ResourceArgs {

    public static final LoginSecurityState Empty = new LoginSecurityState();
    ...
    private LoginSecurityState() {}

    private LoginSecurityState(LoginSecurityState $) {
    ...
    public static Builder builder(LoginSecurityState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoginSecurityState();
        }

        public Builder(LoginSecurityState defaults) {
            $ = new LoginSecurityState(Objects.requireNonNull(defaults));
        }
        ...
        public LoginSecurityState build() {
            return $;
        }
    }
