...
public final class ClientsProvisionParametersPoliciesBySsidStatus7Args extends com.pulumi.resources.ResourceArgs {

    public static final ClientsProvisionParametersPoliciesBySsidStatus7Args Empty = new ClientsProvisionParametersPoliciesBySsidStatus7Args();
    ...
    private ClientsProvisionParametersPoliciesBySsidStatus7Args() {}

    private ClientsProvisionParametersPoliciesBySsidStatus7Args(ClientsProvisionParametersPoliciesBySsidStatus7Args $) {
    ...
    public static Builder builder(ClientsProvisionParametersPoliciesBySsidStatus7Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus7Args();
        }

        public Builder(ClientsProvisionParametersPoliciesBySsidStatus7Args defaults) {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus7Args(Objects.requireNonNull(defaults));
        }
        ...
        public ClientsProvisionParametersPoliciesBySsidStatus7Args build() {
            return $;
        }
    }
