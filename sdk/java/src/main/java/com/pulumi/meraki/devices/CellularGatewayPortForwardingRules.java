...
public class CellularGatewayPortForwardingRules extends com.pulumi.resources.CustomResource {
    ...
    public CellularGatewayPortForwardingRules(String name, CellularGatewayPortForwardingRulesArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:devices/cellularGatewayPortForwardingRules:CellularGatewayPortForwardingRules", name, args == null ? CellularGatewayPortForwardingRulesArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
