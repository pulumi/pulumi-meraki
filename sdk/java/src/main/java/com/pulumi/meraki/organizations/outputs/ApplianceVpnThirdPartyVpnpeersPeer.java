...
import com.pulumi.meraki.organizations.outputs.ApplianceVpnThirdPartyVpnpeersPeerIpsecPolicies;
...
@CustomType
public final class ApplianceVpnThirdPartyVpnpeersPeer {
    /**
     ...
     * 
     */
    private @Nullable ApplianceVpnThirdPartyVpnpeersPeerIpsecPolicies ipsecPolicies;
    /**
    ...
    private ApplianceVpnThirdPartyVpnpeersPeer() {}
    /**
     * @return [optional] The IKE version to be used for the IPsec VPN peer configuration. Defaults to &#39;1&#39; when omitted.
     * 
     */
     ...
     * 
     */
    public Optional<ApplianceVpnThirdPartyVpnpeersPeerIpsecPolicies> ipsecPolicies() {
    ...
    public static Builder builder(ApplianceVpnThirdPartyVpnpeersPeer defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String secret;
        public Builder() {}
        public Builder(ApplianceVpnThirdPartyVpnpeersPeer defaults) {
        ...
        @CustomType.Setter
        public Builder ipsecPolicies(@Nullable ApplianceVpnThirdPartyVpnpeersPeerIpsecPolicies ipsecPolicies) {
        ...
        public ApplianceVpnThirdPartyVpnpeersPeer build() {
            final var _resultValue = new ApplianceVpnThirdPartyVpnpeersPeer();
