...
public final class LicensingCotermLicensesMoveItemRemainderLicenseArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="counts")
    private @Nullable Output<List<LicensingCotermLicensesMoveItemRemainderLicenseCountArgs>> counts;

    /**
     * @return The counts of the license by model type
     * 
     */
    public Optional<Output<List<LicensingCotermLicensesMoveItemRemainderLicenseCountArgs>>> counts() {
    ...
    private @Nullable Output<List<LicensingCotermLicensesMoveItemRemainderLicenseEditionArgs>> editions;

    /**
     * @return The editions of the license for each relevant product type
     * 
     */
    public Optional<Output<List<LicensingCotermLicensesMoveItemRemainderLicenseEditionArgs>>> editions() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder counts(@Nullable Output<List<LicensingCotermLicensesMoveItemRemainderLicenseCountArgs>> counts) {
            $.counts = counts;
            return this;
        }
         ...
         * 
         */
        public Builder counts(List<LicensingCotermLicensesMoveItemRemainderLicenseCountArgs> counts) {
         ...
         * 
         */
        public Builder editions(@Nullable Output<List<LicensingCotermLicensesMoveItemRemainderLicenseEditionArgs>> editions) {
            $.editions = editions;
            return this;
        }
         ...
         * 
         */
        public Builder editions(List<LicensingCotermLicensesMoveItemRemainderLicenseEditionArgs> editions) {
