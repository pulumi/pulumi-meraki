...
public class NetworksCombine extends com.pulumi.resources.CustomResource {
     ...
     */
    public NetworksCombine(String name) {
     ...
     */
    public static NetworksCombine get(String name, Output<String> id, @Nullable NetworksCombineState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
