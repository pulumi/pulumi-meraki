...
@CustomType
public final class LicensingSubscriptionSubscriptionsClaimItemCountsSeats {
    /**
    ...
    private LicensingSubscriptionSubscriptionsClaimItemCountsSeats() {}
    /**
     * @return Number of seats in use
     * 
     */
    ...
    public static Builder builder(LicensingSubscriptionSubscriptionsClaimItemCountsSeats defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer limit;
        public Builder() {}
        public Builder(LicensingSubscriptionSubscriptionsClaimItemCountsSeats defaults) {
        ...
        public LicensingSubscriptionSubscriptionsClaimItemCountsSeats build() {
            final var _resultValue = new LicensingSubscriptionSubscriptionsClaimItemCountsSeats();
