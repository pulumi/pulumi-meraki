...
import com.pulumi.meraki.networks.inputs.DevicesClaimVmxItemDetailArgs;
...
public final class DevicesClaimVmxItemArgs extends com.pulumi.resources.ResourceArgs {

    public static final DevicesClaimVmxItemArgs Empty = new DevicesClaimVmxItemArgs();
     ...
     */
    @Import(name="details")
    private @Nullable Output<List<DevicesClaimVmxItemDetailArgs>> details;

    /**
     * @return Additional device information
     * 
     */
    public Optional<Output<List<DevicesClaimVmxItemDetailArgs>>> details() {
    ...
    private DevicesClaimVmxItemArgs() {}

    private DevicesClaimVmxItemArgs(DevicesClaimVmxItemArgs $) {
    ...
    public static Builder builder(DevicesClaimVmxItemArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DevicesClaimVmxItemArgs();
        }

        public Builder(DevicesClaimVmxItemArgs defaults) {
            $ = new DevicesClaimVmxItemArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder details(@Nullable Output<List<DevicesClaimVmxItemDetailArgs>> details) {
            $.details = details;
            return this;
        }
         ...
         * 
         */
        public Builder details(List<DevicesClaimVmxItemDetailArgs> details) {
         ...
         * 
         */
        public Builder details(DevicesClaimVmxItemDetailArgs... details) {
        ...
        public DevicesClaimVmxItemArgs build() {
            return $;
        }
    }
