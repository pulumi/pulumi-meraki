...
public final class GetWirelessConnectionStatsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetWirelessConnectionStatsPlainArgs Empty = new GetWirelessConnectionStatsPlainArgs();
    ...
    private GetWirelessConnectionStatsPlainArgs() {}

    private GetWirelessConnectionStatsPlainArgs(GetWirelessConnectionStatsPlainArgs $) {
        this.apTag = $.apTag;
        this.band = $.band;
    ...
    public static Builder builder(GetWirelessConnectionStatsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetWirelessConnectionStatsPlainArgs();
        }

        public Builder(GetWirelessConnectionStatsPlainArgs defaults) {
            $ = new GetWirelessConnectionStatsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetWirelessConnectionStatsPlainArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("GetWirelessConnectionStatsPlainArgs", "networkId");
            }
            return $;
        }
    }
