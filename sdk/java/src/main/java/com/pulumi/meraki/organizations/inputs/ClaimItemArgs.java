...
import com.pulumi.meraki.organizations.inputs.ClaimItemLicenseArgs;
...
public final class ClaimItemArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClaimItemArgs Empty = new ClaimItemArgs();
    ...
    private @Nullable Output<List<ClaimItemLicenseArgs>> licenses;

    /**
     * @return The licenses claimed
     * 
     */
    public Optional<Output<List<ClaimItemLicenseArgs>>> licenses() {
    ...
    private ClaimItemArgs() {}

    private ClaimItemArgs(ClaimItemArgs $) {
    ...
    public static Builder builder(ClaimItemArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ClaimItemArgs defaults) {
            $ = new ClaimItemArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder licenses(@Nullable Output<List<ClaimItemLicenseArgs>> licenses) {
            $.licenses = licenses;
            return this;
        }
         ...
         * 
         */
        public Builder licenses(List<ClaimItemLicenseArgs> licenses) {
         ...
         * 
         */
        public Builder licenses(ClaimItemLicenseArgs... licenses) {
