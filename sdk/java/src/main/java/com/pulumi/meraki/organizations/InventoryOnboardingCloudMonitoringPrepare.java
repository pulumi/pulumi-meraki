...
public class InventoryOnboardingCloudMonitoringPrepare extends com.pulumi.resources.CustomResource {
     ...
     */
    public InventoryOnboardingCloudMonitoringPrepare(java.lang.String name) {
     ...
     */
    public InventoryOnboardingCloudMonitoringPrepare(java.lang.String name, InventoryOnboardingCloudMonitoringPrepareArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InventoryOnboardingCloudMonitoringPrepare(java.lang.String name, InventoryOnboardingCloudMonitoringPrepareArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:organizations/inventoryOnboardingCloudMonitoringPrepare:InventoryOnboardingCloudMonitoringPrepare", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private InventoryOnboardingCloudMonitoringPrepare(java.lang.String name, Output<java.lang.String> id, @Nullable InventoryOnboardingCloudMonitoringPrepareState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:organizations/inventoryOnboardingCloudMonitoringPrepare:InventoryOnboardingCloudMonitoringPrepare", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static InventoryOnboardingCloudMonitoringPrepare get(java.lang.String name, Output<java.lang.String> id, @Nullable InventoryOnboardingCloudMonitoringPrepareState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
