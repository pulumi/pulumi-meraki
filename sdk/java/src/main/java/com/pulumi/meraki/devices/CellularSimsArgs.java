...
public final class CellularSimsArgs extends com.pulumi.resources.ResourceArgs {

    public static final CellularSimsArgs Empty = new CellularSimsArgs();
    ...
    private CellularSimsArgs() {}

    private CellularSimsArgs(CellularSimsArgs $) {
        this.serial = $.serial;
    ...
    public static Builder builder(CellularSimsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CellularSimsArgs();
        }

        public Builder(CellularSimsArgs defaults) {
            $ = new CellularSimsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CellularSimsArgs build() {
            if ($.serial == null) {
                throw new MissingRequiredPropertyException("CellularSimsArgs", "serial");
            }
            return $;
        }
    }
