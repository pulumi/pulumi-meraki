...
import com.pulumi.meraki.networks.inputs.FirmwareUpgradesStagedEventsDeferState;
import com.pulumi.meraki.networks.outputs.FirmwareUpgradesStagedEventsDeferItem;
 ...
 * 
 */
@ResourceType(type="meraki:networks/firmwareUpgradesStagedEventsDefer:FirmwareUpgradesStagedEventsDefer")
public class FirmwareUpgradesStagedEventsDefer extends com.pulumi.resources.CustomResource {
    @Export(name="item", refs={FirmwareUpgradesStagedEventsDeferItem.class}, tree="[0]")
    private Output<FirmwareUpgradesStagedEventsDeferItem> item;

    public Output<FirmwareUpgradesStagedEventsDeferItem> item() {
        return this.item;
    }
    /**
    ...
    public FirmwareUpgradesStagedEventsDefer(String name, FirmwareUpgradesStagedEventsDeferArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/firmwareUpgradesStagedEventsDefer:FirmwareUpgradesStagedEventsDefer", name, args == null ? FirmwareUpgradesStagedEventsDeferArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
