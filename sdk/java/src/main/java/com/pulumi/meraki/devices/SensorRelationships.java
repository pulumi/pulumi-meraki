 ...
 *                 .related_devices(List.of(Map.of("serial", "string")))
 *                 .build())
 *             .serial("string")
 *             .build());
 * 
...
public class SensorRelationships extends com.pulumi.resources.CustomResource {
     ...
     */
    public SensorRelationships(java.lang.String name) {
     ...
     */
    public SensorRelationships(java.lang.String name, SensorRelationshipsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SensorRelationships(java.lang.String name, SensorRelationshipsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:devices/sensorRelationships:SensorRelationships", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SensorRelationships(java.lang.String name, Output<java.lang.String> id, @Nullable SensorRelationshipsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:devices/sensorRelationships:SensorRelationships", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static SensorRelationships get(java.lang.String name, Output<java.lang.String> id, @Nullable SensorRelationshipsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
