...
import com.pulumi.meraki.networks.outputs.GetEventsEventTypesItem;
...
public final class GetEventsEventTypesResult {
     ...
     * 
     */
    public List<GetEventsEventTypesItem> items() {
        return this.items;
    }
    /**
     * @return networkId path parameter. Network ID
    ...
    public static Builder builder(GetEventsEventTypesResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder items(List<GetEventsEventTypesItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetEventsEventTypesResult", "items");
            }
            this.items = items;
            return this;
        }
        public Builder items(GetEventsEventTypesItem... items) {
            return items(List.of(items));
        }
        @CustomType.Setter
        public Builder networkId(String networkId) {
            if (networkId == null) {
              throw new MissingRequiredPropertyException("GetEventsEventTypesResult", "networkId");
            }
