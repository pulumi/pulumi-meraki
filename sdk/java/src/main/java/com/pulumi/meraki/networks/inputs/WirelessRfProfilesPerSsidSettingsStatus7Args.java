...
public final class WirelessRfProfilesPerSsidSettingsStatus7Args extends com.pulumi.resources.ResourceArgs {

    public static final WirelessRfProfilesPerSsidSettingsStatus7Args Empty = new WirelessRfProfilesPerSsidSettingsStatus7Args();
     ...
     */
    @Import(name="bands")
    private @Nullable Output<WirelessRfProfilesPerSsidSettingsStatus7BandsArgs> bands;

    /**
     * @return Settings related to all bands
     * 
     */
    public Optional<Output<WirelessRfProfilesPerSsidSettingsStatus7BandsArgs>> bands() {
    ...
    private WirelessRfProfilesPerSsidSettingsStatus7Args() {}

    private WirelessRfProfilesPerSsidSettingsStatus7Args(WirelessRfProfilesPerSsidSettingsStatus7Args $) {
    ...
    public static Builder builder(WirelessRfProfilesPerSsidSettingsStatus7Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessRfProfilesPerSsidSettingsStatus7Args();
        }

        public Builder(WirelessRfProfilesPerSsidSettingsStatus7Args defaults) {
            $ = new WirelessRfProfilesPerSsidSettingsStatus7Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder bands(@Nullable Output<WirelessRfProfilesPerSsidSettingsStatus7BandsArgs> bands) {
            $.bands = bands;
            return this;
        }
         ...
         * 
         */
        public Builder bands(WirelessRfProfilesPerSsidSettingsStatus7BandsArgs bands) {
        ...
        public WirelessRfProfilesPerSsidSettingsStatus7Args build() {
            return $;
        }
    }
