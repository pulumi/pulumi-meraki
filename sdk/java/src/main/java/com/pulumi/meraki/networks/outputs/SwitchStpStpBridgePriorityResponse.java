...
@CustomType
public final class SwitchStpStpBridgePriorityResponse {
    /**
    ...
    public static Builder builder(SwitchStpStpBridgePriorityResponse defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> switches;
        public Builder() {}
        public Builder(SwitchStpStpBridgePriorityResponse defaults) {
        ...
        public SwitchStpStpBridgePriorityResponse build() {
            final var _resultValue = new SwitchStpStpBridgePriorityResponse();
