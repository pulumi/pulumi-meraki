...
@CustomType
public final class GetSwitchStacksRoutingStaticRoutesItem {
    /**
    ...
    private GetSwitchStacksRoutingStaticRoutesItem() {}
    /**
     * @return Option to advertise static routes via OSPF
     * 
     */
    ...
    public static Builder builder(GetSwitchStacksRoutingStaticRoutesItem defaults) {
    ...
    public static final class Builder {
        ...
        private String subnet;
        public Builder() {}
        public Builder(GetSwitchStacksRoutingStaticRoutesItem defaults) {
        ...
        public Builder advertiseViaOspfEnabled(Boolean advertiseViaOspfEnabled) {
            if (advertiseViaOspfEnabled == null) {
              throw new MissingRequiredPropertyException("GetSwitchStacksRoutingStaticRoutesItem", "advertiseViaOspfEnabled");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSwitchStacksRoutingStaticRoutesItem", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder nextHopIp(String nextHopIp) {
            if (nextHopIp == null) {
              throw new MissingRequiredPropertyException("GetSwitchStacksRoutingStaticRoutesItem", "nextHopIp");
            }
        ...
        public Builder preferOverOspfRoutesEnabled(Boolean preferOverOspfRoutesEnabled) {
            if (preferOverOspfRoutesEnabled == null) {
              throw new MissingRequiredPropertyException("GetSwitchStacksRoutingStaticRoutesItem", "preferOverOspfRoutesEnabled");
            }
        ...
        public Builder staticRouteId(String staticRouteId) {
            if (staticRouteId == null) {
              throw new MissingRequiredPropertyException("GetSwitchStacksRoutingStaticRoutesItem", "staticRouteId");
            }
        ...
        public Builder subnet(String subnet) {
            if (subnet == null) {
              throw new MissingRequiredPropertyException("GetSwitchStacksRoutingStaticRoutesItem", "subnet");
            }
            this.subnet = subnet;
            return this;
        }
        public GetSwitchStacksRoutingStaticRoutesItem build() {
            final var _resultValue = new GetSwitchStacksRoutingStaticRoutesItem();
