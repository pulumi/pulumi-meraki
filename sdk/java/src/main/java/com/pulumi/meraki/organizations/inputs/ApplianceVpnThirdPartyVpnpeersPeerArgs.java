...
public final class ApplianceVpnThirdPartyVpnpeersPeerArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplianceVpnThirdPartyVpnpeersPeerArgs Empty = new ApplianceVpnThirdPartyVpnpeersPeerArgs();
    ...
    private @Nullable Output<ApplianceVpnThirdPartyVpnpeersPeerIpsecPoliciesArgs> ipsecPolicies;
     ...
     * 
     */
    public Optional<Output<ApplianceVpnThirdPartyVpnpeersPeerIpsecPoliciesArgs>> ipsecPolicies() {
    ...
    private ApplianceVpnThirdPartyVpnpeersPeerArgs() {}

    private ApplianceVpnThirdPartyVpnpeersPeerArgs(ApplianceVpnThirdPartyVpnpeersPeerArgs $) {
    ...
    public static Builder builder(ApplianceVpnThirdPartyVpnpeersPeerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplianceVpnThirdPartyVpnpeersPeerArgs();
        }

        public Builder(ApplianceVpnThirdPartyVpnpeersPeerArgs defaults) {
            $ = new ApplianceVpnThirdPartyVpnpeersPeerArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder ipsecPolicies(@Nullable Output<ApplianceVpnThirdPartyVpnpeersPeerIpsecPoliciesArgs> ipsecPolicies) {
         ...
         * 
         */
        public Builder ipsecPolicies(ApplianceVpnThirdPartyVpnpeersPeerIpsecPoliciesArgs ipsecPolicies) {
        ...
        public ApplianceVpnThirdPartyVpnpeersPeerArgs build() {
            return $;
        }
    }
