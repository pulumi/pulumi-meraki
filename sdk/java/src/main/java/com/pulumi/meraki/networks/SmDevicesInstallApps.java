...
public class SmDevicesInstallApps extends com.pulumi.resources.CustomResource {
     ...
     */
    public SmDevicesInstallApps(java.lang.String name) {
     ...
     */
    public SmDevicesInstallApps(java.lang.String name, SmDevicesInstallAppsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SmDevicesInstallApps(java.lang.String name, SmDevicesInstallAppsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/smDevicesInstallApps:SmDevicesInstallApps", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SmDevicesInstallApps(java.lang.String name, Output<java.lang.String> id, @Nullable SmDevicesInstallAppsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/smDevicesInstallApps:SmDevicesInstallApps", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static SmDevicesInstallApps get(java.lang.String name, Output<java.lang.String> id, @Nullable SmDevicesInstallAppsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
