...
@CustomType
public final class ApplianceFirewallL3FirewallRulesRule {
    /**
    ...
    private ApplianceFirewallL3FirewallRulesRule() {}
    /**
     * @return Description of the rule (optional)
     * 
     */
    ...
    public static Builder builder(ApplianceFirewallL3FirewallRulesRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean syslogEnabled;
        public Builder() {}
        public Builder(ApplianceFirewallL3FirewallRulesRule defaults) {
        ...
        public ApplianceFirewallL3FirewallRulesRule build() {
            final var _resultValue = new ApplianceFirewallL3FirewallRulesRule();
