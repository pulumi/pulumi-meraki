...
@CustomType
public final class FloorPlansBottomLeftCorner {
    /**
     * @return Latitude
     * 
     */
    ...
    public static Builder builder(FloorPlansBottomLeftCorner defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double lng;
        public Builder() {}
        public Builder(FloorPlansBottomLeftCorner defaults) {
        ...
        public FloorPlansBottomLeftCorner build() {
            final var _resultValue = new FloorPlansBottomLeftCorner();
