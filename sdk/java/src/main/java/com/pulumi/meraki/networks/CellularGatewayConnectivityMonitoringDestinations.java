...
public class CellularGatewayConnectivityMonitoringDestinations extends com.pulumi.resources.CustomResource {
     ...
     */
    public CellularGatewayConnectivityMonitoringDestinations(String name) {
     ...
     */
    public CellularGatewayConnectivityMonitoringDestinations(String name, CellularGatewayConnectivityMonitoringDestinationsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static CellularGatewayConnectivityMonitoringDestinations get(String name, Output<String> id, @Nullable CellularGatewayConnectivityMonitoringDestinationsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
