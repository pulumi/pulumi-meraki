...
public final class LicensingSubscriptionSubscriptionsClaimItemCountsSeatsArgs extends com.pulumi.resources.ResourceArgs {

    public static final LicensingSubscriptionSubscriptionsClaimItemCountsSeatsArgs Empty = new LicensingSubscriptionSubscriptionsClaimItemCountsSeatsArgs();
    ...
    private LicensingSubscriptionSubscriptionsClaimItemCountsSeatsArgs() {}

    private LicensingSubscriptionSubscriptionsClaimItemCountsSeatsArgs(LicensingSubscriptionSubscriptionsClaimItemCountsSeatsArgs $) {
    ...
    public static Builder builder(LicensingSubscriptionSubscriptionsClaimItemCountsSeatsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LicensingSubscriptionSubscriptionsClaimItemCountsSeatsArgs();
        }

        public Builder(LicensingSubscriptionSubscriptionsClaimItemCountsSeatsArgs defaults) {
            $ = new LicensingSubscriptionSubscriptionsClaimItemCountsSeatsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LicensingSubscriptionSubscriptionsClaimItemCountsSeatsArgs build() {
            return $;
        }
    }
