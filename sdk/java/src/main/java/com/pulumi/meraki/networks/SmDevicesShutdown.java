...
import com.pulumi.meraki.networks.inputs.SmDevicesShutdownState;
import com.pulumi.meraki.networks.outputs.SmDevicesShutdownItem;
import com.pulumi.meraki.networks.outputs.SmDevicesShutdownParameters;
 ...
 * 
 */
@ResourceType(type="meraki:networks/smDevicesShutdown:SmDevicesShutdown")
public class SmDevicesShutdown extends com.pulumi.resources.CustomResource {
    @Export(name="item", refs={SmDevicesShutdownItem.class}, tree="[0]")
    private Output<SmDevicesShutdownItem> item;

    public Output<SmDevicesShutdownItem> item() {
        return this.item;
    }
    /**
    ...
    @Export(name="parameters", refs={SmDevicesShutdownParameters.class}, tree="[0]")
    private Output<SmDevicesShutdownParameters> parameters;

    public Output<SmDevicesShutdownParameters> parameters() {
    ...
    public SmDevicesShutdown(String name, SmDevicesShutdownArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/smDevicesShutdown:SmDevicesShutdown", name, args == null ? SmDevicesShutdownArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
