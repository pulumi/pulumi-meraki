...
public final class WirelessRfProfilesPerSsidSettingsStatus10Args extends com.pulumi.resources.ResourceArgs {

    public static final WirelessRfProfilesPerSsidSettingsStatus10Args Empty = new WirelessRfProfilesPerSsidSettingsStatus10Args();
     ...
     */
    @Import(name="bands")
    private @Nullable Output<WirelessRfProfilesPerSsidSettingsStatus10BandsArgs> bands;

    /**
     * @return Settings related to all bands
     * 
     */
    public Optional<Output<WirelessRfProfilesPerSsidSettingsStatus10BandsArgs>> bands() {
    ...
    private WirelessRfProfilesPerSsidSettingsStatus10Args() {}

    private WirelessRfProfilesPerSsidSettingsStatus10Args(WirelessRfProfilesPerSsidSettingsStatus10Args $) {
    ...
    public static Builder builder(WirelessRfProfilesPerSsidSettingsStatus10Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessRfProfilesPerSsidSettingsStatus10Args();
        }

        public Builder(WirelessRfProfilesPerSsidSettingsStatus10Args defaults) {
            $ = new WirelessRfProfilesPerSsidSettingsStatus10Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder bands(@Nullable Output<WirelessRfProfilesPerSsidSettingsStatus10BandsArgs> bands) {
            $.bands = bands;
            return this;
        }
         ...
         * 
         */
        public Builder bands(WirelessRfProfilesPerSsidSettingsStatus10BandsArgs bands) {
        ...
        public WirelessRfProfilesPerSsidSettingsStatus10Args build() {
            return $;
        }
    }
