...
public class CameraRoles extends com.pulumi.resources.CustomResource {
     ...
     */
    public CameraRoles(java.lang.String name) {
     ...
     */
    public CameraRoles(java.lang.String name, CameraRolesArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CameraRoles(java.lang.String name, CameraRolesArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:organizations/cameraRoles:CameraRoles", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CameraRoles(java.lang.String name, Output<java.lang.String> id, @Nullable CameraRolesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:organizations/cameraRoles:CameraRoles", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static CameraRoles get(java.lang.String name, Output<java.lang.String> id, @Nullable CameraRolesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
