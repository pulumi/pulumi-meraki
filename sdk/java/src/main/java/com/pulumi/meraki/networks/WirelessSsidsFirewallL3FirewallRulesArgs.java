...
public final class WirelessSsidsFirewallL3FirewallRulesArgs extends com.pulumi.resources.ResourceArgs {

    public static final WirelessSsidsFirewallL3FirewallRulesArgs Empty = new WirelessSsidsFirewallL3FirewallRulesArgs();
    ...
    private WirelessSsidsFirewallL3FirewallRulesArgs() {}

    private WirelessSsidsFirewallL3FirewallRulesArgs(WirelessSsidsFirewallL3FirewallRulesArgs $) {
    ...
    public static Builder builder(WirelessSsidsFirewallL3FirewallRulesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessSsidsFirewallL3FirewallRulesArgs();
        }

        public Builder(WirelessSsidsFirewallL3FirewallRulesArgs defaults) {
            $ = new WirelessSsidsFirewallL3FirewallRulesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WirelessSsidsFirewallL3FirewallRulesArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("WirelessSsidsFirewallL3FirewallRulesArgs", "networkId");
            }
            if ($.number == null) {
                throw new MissingRequiredPropertyException("WirelessSsidsFirewallL3FirewallRulesArgs", "number");
            }
            return $;
        }
    }
