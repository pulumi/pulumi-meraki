...
public final class GetSwitchDhcpV4ServersSeenPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSwitchDhcpV4ServersSeenPlainArgs Empty = new GetSwitchDhcpV4ServersSeenPlainArgs();
    ...
    private GetSwitchDhcpV4ServersSeenPlainArgs() {}

    private GetSwitchDhcpV4ServersSeenPlainArgs(GetSwitchDhcpV4ServersSeenPlainArgs $) {
    ...
    public static Builder builder(GetSwitchDhcpV4ServersSeenPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSwitchDhcpV4ServersSeenPlainArgs();
        }

        public Builder(GetSwitchDhcpV4ServersSeenPlainArgs defaults) {
            $ = new GetSwitchDhcpV4ServersSeenPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSwitchDhcpV4ServersSeenPlainArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("GetSwitchDhcpV4ServersSeenPlainArgs", "networkId");
            }
            return $;
        }
    }
