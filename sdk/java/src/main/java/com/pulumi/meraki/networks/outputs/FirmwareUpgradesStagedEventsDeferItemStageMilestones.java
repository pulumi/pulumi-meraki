...
@CustomType
public final class FirmwareUpgradesStagedEventsDeferItemStageMilestones {
    /**
    ...
    public static Builder builder(FirmwareUpgradesStagedEventsDeferItemStageMilestones defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String startedAt;
        public Builder() {}
        public Builder(FirmwareUpgradesStagedEventsDeferItemStageMilestones defaults) {
        ...
        public FirmwareUpgradesStagedEventsDeferItemStageMilestones build() {
            final var _resultValue = new FirmwareUpgradesStagedEventsDeferItemStageMilestones();
