...
public class ApplianceConnectivityMonitoringDestinations extends com.pulumi.resources.CustomResource {
     ...
     */
    public ApplianceConnectivityMonitoringDestinations(java.lang.String name) {
     ...
     */
    public ApplianceConnectivityMonitoringDestinations(java.lang.String name, ApplianceConnectivityMonitoringDestinationsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ApplianceConnectivityMonitoringDestinations(java.lang.String name, ApplianceConnectivityMonitoringDestinationsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/applianceConnectivityMonitoringDestinations:ApplianceConnectivityMonitoringDestinations", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ApplianceConnectivityMonitoringDestinations(java.lang.String name, Output<java.lang.String> id, @Nullable ApplianceConnectivityMonitoringDestinationsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/applianceConnectivityMonitoringDestinations:ApplianceConnectivityMonitoringDestinations", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ApplianceConnectivityMonitoringDestinations get(java.lang.String name, Output<java.lang.String> id, @Nullable ApplianceConnectivityMonitoringDestinationsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
