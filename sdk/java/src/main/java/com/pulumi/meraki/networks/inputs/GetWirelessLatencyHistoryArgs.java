...
public final class GetWirelessLatencyHistoryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetWirelessLatencyHistoryArgs Empty = new GetWirelessLatencyHistoryArgs();

    /**
     * accessCategory query parameter. Filter by access category.
     * 
     */
    @Import(name="accessCategory")
    private @Nullable Output<String> accessCategory;

    /**
     * @return accessCategory query parameter. Filter by access category.
     * 
     */
    public Optional<Output<String>> accessCategory() {
        return Optional.ofNullable(this.accessCategory);
    }
    ...
    private GetWirelessLatencyHistoryArgs() {}

    private GetWirelessLatencyHistoryArgs(GetWirelessLatencyHistoryArgs $) {
    ...
    public static Builder builder(GetWirelessLatencyHistoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetWirelessLatencyHistoryArgs();
        }

        public Builder(GetWirelessLatencyHistoryArgs defaults) {
            $ = new GetWirelessLatencyHistoryArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param accessCategory accessCategory query parameter. Filter by access category.
         * 
         * @return builder
         * 
         */
        public Builder accessCategory(@Nullable Output<String> accessCategory) {
         ...
         * 
         */
        public Builder accessCategory(String accessCategory) {
            return accessCategory(Output.of(accessCategory));
        }
        ...
        public GetWirelessLatencyHistoryArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("GetWirelessLatencyHistoryArgs", "networkId");
            }
            return $;
        }
    }
