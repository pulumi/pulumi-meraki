...
public final class GetAlertsHistoryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetAlertsHistoryArgs Empty = new GetAlertsHistoryArgs();
    ...
    private GetAlertsHistoryArgs() {}

    private GetAlertsHistoryArgs(GetAlertsHistoryArgs $) {
    ...
    public static Builder builder(GetAlertsHistoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAlertsHistoryArgs();
        }

        public Builder(GetAlertsHistoryArgs defaults) {
            $ = new GetAlertsHistoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAlertsHistoryArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("GetAlertsHistoryArgs", "networkId");
            }
            return $;
        }
    }
