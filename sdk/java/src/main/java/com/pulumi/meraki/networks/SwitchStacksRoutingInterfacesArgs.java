...
public final class SwitchStacksRoutingInterfacesArgs extends com.pulumi.resources.ResourceArgs {

    public static final SwitchStacksRoutingInterfacesArgs Empty = new SwitchStacksRoutingInterfacesArgs();
    ...
    private SwitchStacksRoutingInterfacesArgs() {}

    private SwitchStacksRoutingInterfacesArgs(SwitchStacksRoutingInterfacesArgs $) {
    ...
    public static Builder builder(SwitchStacksRoutingInterfacesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchStacksRoutingInterfacesArgs();
        }

        public Builder(SwitchStacksRoutingInterfacesArgs defaults) {
            $ = new SwitchStacksRoutingInterfacesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SwitchStacksRoutingInterfacesArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("SwitchStacksRoutingInterfacesArgs", "networkId");
            }
            if ($.switchStackId == null) {
                throw new MissingRequiredPropertyException("SwitchStacksRoutingInterfacesArgs", "switchStackId");
            }
            return $;
        }
    }
