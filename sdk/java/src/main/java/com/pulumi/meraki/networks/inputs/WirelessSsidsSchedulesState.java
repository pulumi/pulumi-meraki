...
public final class WirelessSsidsSchedulesState extends com.pulumi.resources.ResourceArgs {

    public static final WirelessSsidsSchedulesState Empty = new WirelessSsidsSchedulesState();
    ...
    private WirelessSsidsSchedulesState() {}

    private WirelessSsidsSchedulesState(WirelessSsidsSchedulesState $) {
    ...
    public static Builder builder(WirelessSsidsSchedulesState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessSsidsSchedulesState();
        }

        public Builder(WirelessSsidsSchedulesState defaults) {
            $ = new WirelessSsidsSchedulesState(Objects.requireNonNull(defaults));
        }
        ...
        public WirelessSsidsSchedulesState build() {
            return $;
        }
    }
