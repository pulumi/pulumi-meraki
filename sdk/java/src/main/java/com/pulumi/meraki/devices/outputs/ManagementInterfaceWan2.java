...
@CustomType
public final class ManagementInterfaceWan2 {
    /**
    ...
    public static Builder builder(ManagementInterfaceWan2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String wanEnabled;
        public Builder() {}
        public Builder(ManagementInterfaceWan2 defaults) {
        ...
        public ManagementInterfaceWan2 build() {
            final var _resultValue = new ManagementInterfaceWan2();
