...
@CustomType
public final class FloorPlansCenter {
    /**
     * @return Latitude
     * 
     */
    ...
    public static Builder builder(FloorPlansCenter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double lng;
        public Builder() {}
        public Builder(FloorPlansCenter defaults) {
        ...
        public FloorPlansCenter build() {
            final var _resultValue = new FloorPlansCenter();
