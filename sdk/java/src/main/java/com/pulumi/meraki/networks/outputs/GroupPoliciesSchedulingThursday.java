...
@CustomType
public final class GroupPoliciesSchedulingThursday {
    /**
    ...
    private GroupPoliciesSchedulingThursday() {}
    /**
     * @return Whether the schedule is active (true) or inactive (false) during the time specified between &#39;from&#39; and &#39;to&#39;. Defaults to true.
     * 
     */
    ...
    public static Builder builder(GroupPoliciesSchedulingThursday defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String to;
        public Builder() {}
        public Builder(GroupPoliciesSchedulingThursday defaults) {
        ...
        public GroupPoliciesSchedulingThursday build() {
            final var _resultValue = new GroupPoliciesSchedulingThursday();
