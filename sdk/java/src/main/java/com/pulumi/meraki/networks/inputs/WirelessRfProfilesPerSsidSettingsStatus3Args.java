...
public final class WirelessRfProfilesPerSsidSettingsStatus3Args extends com.pulumi.resources.ResourceArgs {

    public static final WirelessRfProfilesPerSsidSettingsStatus3Args Empty = new WirelessRfProfilesPerSsidSettingsStatus3Args();
     ...
     */
    @Import(name="bands")
    private @Nullable Output<WirelessRfProfilesPerSsidSettingsStatus3BandsArgs> bands;

    /**
     * @return Settings related to all bands
     * 
     */
    public Optional<Output<WirelessRfProfilesPerSsidSettingsStatus3BandsArgs>> bands() {
    ...
    private WirelessRfProfilesPerSsidSettingsStatus3Args() {}

    private WirelessRfProfilesPerSsidSettingsStatus3Args(WirelessRfProfilesPerSsidSettingsStatus3Args $) {
    ...
    public static Builder builder(WirelessRfProfilesPerSsidSettingsStatus3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessRfProfilesPerSsidSettingsStatus3Args();
        }

        public Builder(WirelessRfProfilesPerSsidSettingsStatus3Args defaults) {
            $ = new WirelessRfProfilesPerSsidSettingsStatus3Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder bands(@Nullable Output<WirelessRfProfilesPerSsidSettingsStatus3BandsArgs> bands) {
            $.bands = bands;
            return this;
        }
         ...
         * 
         */
        public Builder bands(WirelessRfProfilesPerSsidSettingsStatus3BandsArgs bands) {
        ...
        public WirelessRfProfilesPerSsidSettingsStatus3Args build() {
            return $;
        }
    }
