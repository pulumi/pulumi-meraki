...
public final class GetSummaryTopClientsManufacturersByUsagePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSummaryTopClientsManufacturersByUsagePlainArgs Empty = new GetSummaryTopClientsManufacturersByUsagePlainArgs();
    ...
    private GetSummaryTopClientsManufacturersByUsagePlainArgs() {}

    private GetSummaryTopClientsManufacturersByUsagePlainArgs(GetSummaryTopClientsManufacturersByUsagePlainArgs $) {
    ...
    public static Builder builder(GetSummaryTopClientsManufacturersByUsagePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSummaryTopClientsManufacturersByUsagePlainArgs();
        }

        public Builder(GetSummaryTopClientsManufacturersByUsagePlainArgs defaults) {
            $ = new GetSummaryTopClientsManufacturersByUsagePlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSummaryTopClientsManufacturersByUsagePlainArgs build() {
            if ($.organizationId == null) {
                throw new MissingRequiredPropertyException("GetSummaryTopClientsManufacturersByUsagePlainArgs", "organizationId");
            }
            return $;
        }
    }
