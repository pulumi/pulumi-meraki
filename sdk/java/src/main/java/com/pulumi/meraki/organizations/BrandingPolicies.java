...
public class BrandingPolicies extends com.pulumi.resources.CustomResource {
     ...
     */
    public BrandingPolicies(String name) {
     ...
     */
    public static BrandingPolicies get(String name, Output<String> id, @Nullable BrandingPoliciesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
