...
public final class WirelessSsidsRadiusAccountingServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final WirelessSsidsRadiusAccountingServerArgs Empty = new WirelessSsidsRadiusAccountingServerArgs();
    ...
    private WirelessSsidsRadiusAccountingServerArgs() {}

    private WirelessSsidsRadiusAccountingServerArgs(WirelessSsidsRadiusAccountingServerArgs $) {
    ...
    public static Builder builder(WirelessSsidsRadiusAccountingServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessSsidsRadiusAccountingServerArgs();
        }

        public Builder(WirelessSsidsRadiusAccountingServerArgs defaults) {
            $ = new WirelessSsidsRadiusAccountingServerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WirelessSsidsRadiusAccountingServerArgs build() {
            return $;
        }
    }
