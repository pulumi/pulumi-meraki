...
public final class ClientsProvisionParametersPoliciesBySsidStatus3Args extends com.pulumi.resources.ResourceArgs {

    public static final ClientsProvisionParametersPoliciesBySsidStatus3Args Empty = new ClientsProvisionParametersPoliciesBySsidStatus3Args();
    ...
    private ClientsProvisionParametersPoliciesBySsidStatus3Args() {}

    private ClientsProvisionParametersPoliciesBySsidStatus3Args(ClientsProvisionParametersPoliciesBySsidStatus3Args $) {
    ...
    public static Builder builder(ClientsProvisionParametersPoliciesBySsidStatus3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus3Args();
        }

        public Builder(ClientsProvisionParametersPoliciesBySsidStatus3Args defaults) {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus3Args(Objects.requireNonNull(defaults));
        }
        ...
        public ClientsProvisionParametersPoliciesBySsidStatus3Args build() {
            return $;
        }
    }
