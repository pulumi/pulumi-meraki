...
import com.pulumi.meraki.networks.inputs.WebhooksPayloadTemplatesSharingArgs;
...
public final class WebhooksPayloadTemplatesState extends com.pulumi.resources.ResourceArgs {

    public static final WebhooksPayloadTemplatesState Empty = new WebhooksPayloadTemplatesState();
     ...
     */
    @Import(name="sharing")
    private @Nullable Output<WebhooksPayloadTemplatesSharingArgs> sharing;

    /**
     * @return Information on which entities have access to the template
     * 
     */
    public Optional<Output<WebhooksPayloadTemplatesSharingArgs>> sharing() {
    ...
    private WebhooksPayloadTemplatesState() {}

    private WebhooksPayloadTemplatesState(WebhooksPayloadTemplatesState $) {
        this.body = $.body;
    ...
    public static Builder builder(WebhooksPayloadTemplatesState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebhooksPayloadTemplatesState();
        }

        public Builder(WebhooksPayloadTemplatesState defaults) {
            $ = new WebhooksPayloadTemplatesState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param sharing Information on which entities have access to the template
         * 
         * @return builder
         * 
         */
        public Builder sharing(@Nullable Output<WebhooksPayloadTemplatesSharingArgs> sharing) {
            $.sharing = sharing;
            return this;
        }
         ...
         * 
         */
        public Builder sharing(WebhooksPayloadTemplatesSharingArgs sharing) {
            return sharing(Output.of(sharing));
        }

        /**
         * @param type The type of the payload template
         * 
         * @return builder
         * 
         */
        ...
        public WebhooksPayloadTemplatesState build() {
            return $;
        }
    }
