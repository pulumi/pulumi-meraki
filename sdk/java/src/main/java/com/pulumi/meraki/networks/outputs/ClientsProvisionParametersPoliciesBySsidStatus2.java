...
@CustomType
public final class ClientsProvisionParametersPoliciesBySsidStatus2 {
    /**
    ...
    public static Builder builder(ClientsProvisionParametersPoliciesBySsidStatus2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String groupPolicyId;
        public Builder() {}
        public Builder(ClientsProvisionParametersPoliciesBySsidStatus2 defaults) {
        ...
        public ClientsProvisionParametersPoliciesBySsidStatus2 build() {
            final var _resultValue = new ClientsProvisionParametersPoliciesBySsidStatus2();
