...
public final class BrandingPoliciesState extends com.pulumi.resources.ResourceArgs {

    public static final BrandingPoliciesState Empty = new BrandingPoliciesState();
    ...
    private BrandingPoliciesState() {}

    private BrandingPoliciesState(BrandingPoliciesState $) {
    ...
    public static Builder builder(BrandingPoliciesState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BrandingPoliciesState();
        }

        public Builder(BrandingPoliciesState defaults) {
            $ = new BrandingPoliciesState(Objects.requireNonNull(defaults));
        }
        ...
        public BrandingPoliciesState build() {
            return $;
        }
    }
