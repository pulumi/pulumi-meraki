...
@CustomType
public final class FloorPlansBottomRightCorner {
    /**
     * @return Latitude
     * 
     */
    ...
    private FloorPlansBottomRightCorner() {}
    /**
     * @return Latitude
     * 
     */
    ...
    public static Builder builder(FloorPlansBottomRightCorner defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double lng;
        public Builder() {}
        public Builder(FloorPlansBottomRightCorner defaults) {
        ...
        public FloorPlansBottomRightCorner build() {
            final var _resultValue = new FloorPlansBottomRightCorner();
