...
import com.pulumi.meraki.networks.outputs.WirelessRfProfilesPerSsidSettingsStatus11Bands;
...
@CustomType
public final class WirelessRfProfilesPerSsidSettingsStatus11 {
    /**
     ...
     * 
     */
    private @Nullable WirelessRfProfilesPerSsidSettingsStatus11Bands bands;
    /**
     ...
     * 
     */
    public Optional<WirelessRfProfilesPerSsidSettingsStatus11Bands> bands() {
    ...
    public static Builder builder(WirelessRfProfilesPerSsidSettingsStatus11 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String name;
        public Builder() {}
        public Builder(WirelessRfProfilesPerSsidSettingsStatus11 defaults) {
        ...
        @CustomType.Setter
        public Builder bands(@Nullable WirelessRfProfilesPerSsidSettingsStatus11Bands bands) {
        ...
        public WirelessRfProfilesPerSsidSettingsStatus11 build() {
            final var _resultValue = new WirelessRfProfilesPerSsidSettingsStatus11();
