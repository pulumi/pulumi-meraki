...
import com.pulumi.meraki.organizations.outputs.GetDevicesAvailabilitiesItem;
...
@CustomType
public final class GetDevicesAvailabilitiesResult {
    /**
     ...
     * 
     */
    public List<GetDevicesAvailabilitiesItem> items() {
        return this.items;
    }
    /**
     * @return networkIds query parameter. Optional parameter to filter device availabilities by network ID. This filter uses multiple exact matches.
    ...
    public static Builder builder(GetDevicesAvailabilitiesResult defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(List<GetDevicesAvailabilitiesItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetDevicesAvailabilitiesResult", "items");
            }
            this.items = items;
            return this;
        }
        public Builder items(GetDevicesAvailabilitiesItem... items) {
        ...
        public Builder organizationId(String organizationId) {
            if (organizationId == null) {
              throw new MissingRequiredPropertyException("GetDevicesAvailabilitiesResult", "organizationId");
            }
