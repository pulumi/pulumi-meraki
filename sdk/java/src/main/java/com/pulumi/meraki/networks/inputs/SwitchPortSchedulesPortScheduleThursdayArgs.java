...
public final class SwitchPortSchedulesPortScheduleThursdayArgs extends com.pulumi.resources.ResourceArgs {

    public static final SwitchPortSchedulesPortScheduleThursdayArgs Empty = new SwitchPortSchedulesPortScheduleThursdayArgs();
    ...
    private SwitchPortSchedulesPortScheduleThursdayArgs() {}

    private SwitchPortSchedulesPortScheduleThursdayArgs(SwitchPortSchedulesPortScheduleThursdayArgs $) {
        this.active = $.active;
        this.from = $.from;
        this.to = $.to;
    }
    ...
    public static Builder builder(SwitchPortSchedulesPortScheduleThursdayArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchPortSchedulesPortScheduleThursdayArgs();
        }

        public Builder(SwitchPortSchedulesPortScheduleThursdayArgs defaults) {
            $ = new SwitchPortSchedulesPortScheduleThursdayArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SwitchPortSchedulesPortScheduleThursdayArgs build() {
            return $;
        }
    }
