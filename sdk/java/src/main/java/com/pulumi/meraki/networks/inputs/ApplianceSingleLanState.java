...
public final class ApplianceSingleLanState extends com.pulumi.resources.ResourceArgs {

    public static final ApplianceSingleLanState Empty = new ApplianceSingleLanState();
    ...
    private ApplianceSingleLanState() {}

    private ApplianceSingleLanState(ApplianceSingleLanState $) {
    ...
    public static Builder builder(ApplianceSingleLanState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplianceSingleLanState();
        }

        public Builder(ApplianceSingleLanState defaults) {
            $ = new ApplianceSingleLanState(Objects.requireNonNull(defaults));
        }
        ...
        public ApplianceSingleLanState build() {
            return $;
        }
    }
