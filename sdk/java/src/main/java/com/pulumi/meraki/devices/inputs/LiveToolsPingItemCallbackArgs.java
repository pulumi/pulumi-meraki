...
public final class LiveToolsPingItemCallbackArgs extends com.pulumi.resources.ResourceArgs {

    public static final LiveToolsPingItemCallbackArgs Empty = new LiveToolsPingItemCallbackArgs();
    ...
    private LiveToolsPingItemCallbackArgs() {}

    private LiveToolsPingItemCallbackArgs(LiveToolsPingItemCallbackArgs $) {
        this.id = $.id;
        this.status = $.status;
        this.url = $.url;
    }
    ...
    public static Builder builder(LiveToolsPingItemCallbackArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LiveToolsPingItemCallbackArgs();
        }

        public Builder(LiveToolsPingItemCallbackArgs defaults) {
            $ = new LiveToolsPingItemCallbackArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LiveToolsPingItemCallbackArgs build() {
            return $;
        }
    }
