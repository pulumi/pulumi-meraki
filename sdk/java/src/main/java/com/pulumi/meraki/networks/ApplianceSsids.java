...
public class ApplianceSsids extends com.pulumi.resources.CustomResource {
     ...
     */
    public ApplianceSsids(java.lang.String name) {
     ...
     */
    public ApplianceSsids(java.lang.String name, ApplianceSsidsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ApplianceSsids(java.lang.String name, ApplianceSsidsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/applianceSsids:ApplianceSsids", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ApplianceSsids(java.lang.String name, Output<java.lang.String> id, @Nullable ApplianceSsidsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/applianceSsids:ApplianceSsids", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ApplianceSsids get(java.lang.String name, Output<java.lang.String> id, @Nullable ApplianceSsidsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
