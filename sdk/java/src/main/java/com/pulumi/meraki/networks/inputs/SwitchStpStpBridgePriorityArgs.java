...
public final class SwitchStpStpBridgePriorityArgs extends com.pulumi.resources.ResourceArgs {

    public static final SwitchStpStpBridgePriorityArgs Empty = new SwitchStpStpBridgePriorityArgs();
    ...
    private SwitchStpStpBridgePriorityArgs() {}

    private SwitchStpStpBridgePriorityArgs(SwitchStpStpBridgePriorityArgs $) {
        this.stacks = $.stacks;
    ...
    public static Builder builder(SwitchStpStpBridgePriorityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchStpStpBridgePriorityArgs();
        }

        public Builder(SwitchStpStpBridgePriorityArgs defaults) {
            $ = new SwitchStpStpBridgePriorityArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param stpPriority STP priority for switch, stacks, or switch profiles
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param switchProfiles List of switch profile IDs
         * 
         * @return builder
         * 
         */
        ...
        public SwitchStpStpBridgePriorityArgs build() {
            return $;
        }
    }
