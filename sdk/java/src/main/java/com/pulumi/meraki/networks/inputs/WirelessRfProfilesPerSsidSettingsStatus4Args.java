...
public final class WirelessRfProfilesPerSsidSettingsStatus4Args extends com.pulumi.resources.ResourceArgs {

    public static final WirelessRfProfilesPerSsidSettingsStatus4Args Empty = new WirelessRfProfilesPerSsidSettingsStatus4Args();
     ...
     */
    @Import(name="bands")
    private @Nullable Output<WirelessRfProfilesPerSsidSettingsStatus4BandsArgs> bands;

    /**
     * @return Settings related to all bands
     * 
     */
    public Optional<Output<WirelessRfProfilesPerSsidSettingsStatus4BandsArgs>> bands() {
    ...
    private WirelessRfProfilesPerSsidSettingsStatus4Args() {}

    private WirelessRfProfilesPerSsidSettingsStatus4Args(WirelessRfProfilesPerSsidSettingsStatus4Args $) {
    ...
    public static Builder builder(WirelessRfProfilesPerSsidSettingsStatus4Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessRfProfilesPerSsidSettingsStatus4Args();
        }

        public Builder(WirelessRfProfilesPerSsidSettingsStatus4Args defaults) {
            $ = new WirelessRfProfilesPerSsidSettingsStatus4Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder bands(@Nullable Output<WirelessRfProfilesPerSsidSettingsStatus4BandsArgs> bands) {
            $.bands = bands;
            return this;
        }
         ...
         * 
         */
        public Builder bands(WirelessRfProfilesPerSsidSettingsStatus4BandsArgs bands) {
        ...
        public WirelessRfProfilesPerSsidSettingsStatus4Args build() {
            return $;
        }
    }
