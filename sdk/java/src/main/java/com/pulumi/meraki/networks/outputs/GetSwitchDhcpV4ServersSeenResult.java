...
import com.pulumi.meraki.networks.outputs.GetSwitchDhcpV4ServersSeenItem;
...
@CustomType
public final class GetSwitchDhcpV4ServersSeenResult {
    /**
     ...
     * 
     */
    public List<GetSwitchDhcpV4ServersSeenItem> items() {
        return this.items;
    }
    /**
     * @return networkId path parameter. Network ID
    ...
    public static Builder builder(GetSwitchDhcpV4ServersSeenResult defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(List<GetSwitchDhcpV4ServersSeenItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetSwitchDhcpV4ServersSeenResult", "items");
            }
            this.items = items;
            return this;
        }
        public Builder items(GetSwitchDhcpV4ServersSeenItem... items) {
            return items(List.of(items));
        }
        @CustomType.Setter
        public Builder networkId(String networkId) {
            if (networkId == null) {
              throw new MissingRequiredPropertyException("GetSwitchDhcpV4ServersSeenResult", "networkId");
            }
