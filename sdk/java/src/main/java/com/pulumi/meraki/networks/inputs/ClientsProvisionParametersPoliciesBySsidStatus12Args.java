...
public final class ClientsProvisionParametersPoliciesBySsidStatus12Args extends com.pulumi.resources.ResourceArgs {

    public static final ClientsProvisionParametersPoliciesBySsidStatus12Args Empty = new ClientsProvisionParametersPoliciesBySsidStatus12Args();
    ...
    private ClientsProvisionParametersPoliciesBySsidStatus12Args() {}

    private ClientsProvisionParametersPoliciesBySsidStatus12Args(ClientsProvisionParametersPoliciesBySsidStatus12Args $) {
    ...
    public static Builder builder(ClientsProvisionParametersPoliciesBySsidStatus12Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus12Args();
        }

        public Builder(ClientsProvisionParametersPoliciesBySsidStatus12Args defaults) {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus12Args(Objects.requireNonNull(defaults));
        }
        ...
        public ClientsProvisionParametersPoliciesBySsidStatus12Args build() {
            return $;
        }
    }
