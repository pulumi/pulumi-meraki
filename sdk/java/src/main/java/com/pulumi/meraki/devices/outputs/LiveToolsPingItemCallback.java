...
@CustomType
public final class LiveToolsPingItemCallback {
    /**
    ...
    private LiveToolsPingItemCallback() {}
    /**
     * @return The ID of the callback. To check the status of the callback, use this ID in a request to /webhooks/callbacks/statuses/{id}
     * 
     */
    ...
    public static Builder builder(LiveToolsPingItemCallback defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String url;
        public Builder() {}
        public Builder(LiveToolsPingItemCallback defaults) {
        ...
        public LiveToolsPingItemCallback build() {
            final var _resultValue = new LiveToolsPingItemCallback();
            _resultValue.id = id;
