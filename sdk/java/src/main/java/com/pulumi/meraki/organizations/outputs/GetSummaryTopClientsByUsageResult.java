...
import com.pulumi.meraki.organizations.outputs.GetSummaryTopClientsByUsageItem;
...
@CustomType
public final class GetSummaryTopClientsByUsageResult {
    /**
    ...
    private String id;
    /**
     * @return Array of ResponseOrganizationsGetOrganizationSummaryTopClientsByUsage
     * 
     */
    private List<GetSummaryTopClientsByUsageItem> items;
    /**
     ...
     * 
     */
    public List<GetSummaryTopClientsByUsageItem> items() {
        return this.items;
    }
    /**
     * @return organizationId path parameter. Organization ID
    ...
    public static Builder builder(GetSummaryTopClientsByUsageResult defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double timespan;
        public Builder() {}
        public Builder(GetSummaryTopClientsByUsageResult defaults) {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetSummaryTopClientsByUsageResult", "id");
            }
            this.id = id;
            return this;
        }
        @CustomType.Setter
        public Builder items(List<GetSummaryTopClientsByUsageItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetSummaryTopClientsByUsageResult", "items");
            }
            this.items = items;
            return this;
        }
        public Builder items(GetSummaryTopClientsByUsageItem... items) {
            return items(List.of(items));
        }
        @CustomType.Setter
        public Builder organizationId(String organizationId) {
            if (organizationId == null) {
              throw new MissingRequiredPropertyException("GetSummaryTopClientsByUsageResult", "organizationId");
            }
        ...
        public GetSummaryTopClientsByUsageResult build() {
            final var _resultValue = new GetSummaryTopClientsByUsageResult();
            _resultValue.id = id;
