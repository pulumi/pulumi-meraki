...
public final class WirelessRfProfilesState extends com.pulumi.resources.ResourceArgs {

    public static final WirelessRfProfilesState Empty = new WirelessRfProfilesState();
    ...
    private WirelessRfProfilesState() {}

    private WirelessRfProfilesState(WirelessRfProfilesState $) {
    ...
    public static Builder builder(WirelessRfProfilesState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessRfProfilesState();
        }

        public Builder(WirelessRfProfilesState defaults) {
            $ = new WirelessRfProfilesState(Objects.requireNonNull(defaults));
        }
        ...
        public WirelessRfProfilesState build() {
            return $;
        }
    }
