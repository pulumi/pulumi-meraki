...
public final class BindItemArgs extends com.pulumi.resources.ResourceArgs {

    public static final BindItemArgs Empty = new BindItemArgs();
    ...
    private BindItemArgs() {}

    private BindItemArgs(BindItemArgs $) {
    ...
    public static Builder builder(BindItemArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(BindItemArgs defaults) {
            $ = new BindItemArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param configTemplateId ID of the config template the network is being bound to
         * 
         * @return builder
         * 
         */
