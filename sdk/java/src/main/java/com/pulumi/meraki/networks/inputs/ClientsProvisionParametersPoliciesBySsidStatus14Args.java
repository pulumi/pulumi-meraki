...
public final class ClientsProvisionParametersPoliciesBySsidStatus14Args extends com.pulumi.resources.ResourceArgs {

    public static final ClientsProvisionParametersPoliciesBySsidStatus14Args Empty = new ClientsProvisionParametersPoliciesBySsidStatus14Args();
    ...
    private ClientsProvisionParametersPoliciesBySsidStatus14Args() {}

    private ClientsProvisionParametersPoliciesBySsidStatus14Args(ClientsProvisionParametersPoliciesBySsidStatus14Args $) {
    ...
    public static Builder builder(ClientsProvisionParametersPoliciesBySsidStatus14Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus14Args();
        }

        public Builder(ClientsProvisionParametersPoliciesBySsidStatus14Args defaults) {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus14Args(Objects.requireNonNull(defaults));
        }
        ...
        public ClientsProvisionParametersPoliciesBySsidStatus14Args build() {
            return $;
        }
    }
