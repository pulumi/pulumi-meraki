...
public final class ClientsProvisionParametersPoliciesBySsidStatus6Args extends com.pulumi.resources.ResourceArgs {

    public static final ClientsProvisionParametersPoliciesBySsidStatus6Args Empty = new ClientsProvisionParametersPoliciesBySsidStatus6Args();
    ...
    private ClientsProvisionParametersPoliciesBySsidStatus6Args() {}

    private ClientsProvisionParametersPoliciesBySsidStatus6Args(ClientsProvisionParametersPoliciesBySsidStatus6Args $) {
    ...
    public static Builder builder(ClientsProvisionParametersPoliciesBySsidStatus6Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus6Args();
        }

        public Builder(ClientsProvisionParametersPoliciesBySsidStatus6Args defaults) {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus6Args(Objects.requireNonNull(defaults));
        }
        ...
        public ClientsProvisionParametersPoliciesBySsidStatus6Args build() {
            return $;
        }
    }
