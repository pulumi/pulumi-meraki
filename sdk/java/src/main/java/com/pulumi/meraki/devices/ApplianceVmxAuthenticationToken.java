...
public class ApplianceVmxAuthenticationToken extends com.pulumi.resources.CustomResource {
     ...
     */
    public ApplianceVmxAuthenticationToken(String name) {
     ...
     */
    public static ApplianceVmxAuthenticationToken get(String name, Output<String> id, @Nullable ApplianceVmxAuthenticationTokenState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
