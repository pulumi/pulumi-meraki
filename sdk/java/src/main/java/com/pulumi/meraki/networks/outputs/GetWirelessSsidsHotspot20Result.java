...
import com.pulumi.meraki.networks.outputs.GetWirelessSsidsHotspot20Item;
...
public final class GetWirelessSsidsHotspot20Result {
    ...
    public static Builder builder(GetWirelessSsidsHotspot20Result defaults) {
    ...
    public static final class Builder {
        ...
        public Builder item(GetWirelessSsidsHotspot20Item item) {
            if (item == null) {
              throw new MissingRequiredPropertyException("GetWirelessSsidsHotspot20Result", "item");
            }
            this.item = item;
            return this;
        }
        ...
        public Builder networkId(String networkId) {
            if (networkId == null) {
              throw new MissingRequiredPropertyException("GetWirelessSsidsHotspot20Result", "networkId");
            }
        ...
        public Builder number(String number) {
            if (number == null) {
              throw new MissingRequiredPropertyException("GetWirelessSsidsHotspot20Result", "number");
            }
            this.number = number;
            return this;
        }
