...
import com.pulumi.meraki.networks.inputs.ApplianceWarmSpareWan1Args;
import com.pulumi.meraki.networks.inputs.ApplianceWarmSpareWan2Args;
...
public final class ApplianceWarmSpareState extends com.pulumi.resources.ResourceArgs {

    public static final ApplianceWarmSpareState Empty = new ApplianceWarmSpareState();
    ...
    @Import(name="wan1")
    private @Nullable Output<ApplianceWarmSpareWan1Args> wan1;

    public Optional<Output<ApplianceWarmSpareWan1Args>> wan1() {
        return Optional.ofNullable(this.wan1);
    }

    @Import(name="wan2")
    private @Nullable Output<ApplianceWarmSpareWan2Args> wan2;

    public Optional<Output<ApplianceWarmSpareWan2Args>> wan2() {
        return Optional.ofNullable(this.wan2);
    }

    private ApplianceWarmSpareState() {}

    private ApplianceWarmSpareState(ApplianceWarmSpareState $) {
    ...
    public static Builder builder(ApplianceWarmSpareState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplianceWarmSpareState();
        }

        public Builder(ApplianceWarmSpareState defaults) {
            $ = new ApplianceWarmSpareState(Objects.requireNonNull(defaults));
        }
        ...
        public Builder wan1(@Nullable Output<ApplianceWarmSpareWan1Args> wan1) {
            $.wan1 = wan1;
            return this;
        }

        public Builder wan1(ApplianceWarmSpareWan1Args wan1) {
            return wan1(Output.of(wan1));
        }

        public Builder wan2(@Nullable Output<ApplianceWarmSpareWan2Args> wan2) {
            $.wan2 = wan2;
            return this;
        }

        public Builder wan2(ApplianceWarmSpareWan2Args wan2) {
            return wan2(Output.of(wan2));
        }

        public ApplianceWarmSpareState build() {
            return $;
        }
    }
