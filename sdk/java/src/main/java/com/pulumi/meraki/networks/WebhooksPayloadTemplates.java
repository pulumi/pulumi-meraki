...
public class WebhooksPayloadTemplates extends com.pulumi.resources.CustomResource {
    ...
    private WebhooksPayloadTemplates(java.lang.String name, Output<java.lang.String> id, @Nullable WebhooksPayloadTemplatesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static WebhooksPayloadTemplates get(java.lang.String name, Output<java.lang.String> id, @Nullable WebhooksPayloadTemplatesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
