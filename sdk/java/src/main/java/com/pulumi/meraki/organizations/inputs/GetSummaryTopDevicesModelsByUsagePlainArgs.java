...
public final class GetSummaryTopDevicesModelsByUsagePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSummaryTopDevicesModelsByUsagePlainArgs Empty = new GetSummaryTopDevicesModelsByUsagePlainArgs();
    ...
    private GetSummaryTopDevicesModelsByUsagePlainArgs() {}

    private GetSummaryTopDevicesModelsByUsagePlainArgs(GetSummaryTopDevicesModelsByUsagePlainArgs $) {
    ...
    public static Builder builder(GetSummaryTopDevicesModelsByUsagePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSummaryTopDevicesModelsByUsagePlainArgs();
        }

        public Builder(GetSummaryTopDevicesModelsByUsagePlainArgs defaults) {
            $ = new GetSummaryTopDevicesModelsByUsagePlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSummaryTopDevicesModelsByUsagePlainArgs build() {
            if ($.organizationId == null) {
                throw new MissingRequiredPropertyException("GetSummaryTopDevicesModelsByUsagePlainArgs", "organizationId");
            }
            return $;
        }
    }
