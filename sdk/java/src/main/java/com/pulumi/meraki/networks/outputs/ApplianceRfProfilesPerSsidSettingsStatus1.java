...
@CustomType
public final class ApplianceRfProfilesPerSsidSettingsStatus1 {
    /**
    ...
    private ApplianceRfProfilesPerSsidSettingsStatus1() {}
    /**
     * @return Band mode of this SSID
     * 
     */
    ...
    public static Builder builder(ApplianceRfProfilesPerSsidSettingsStatus1 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean bandSteeringEnabled;
        public Builder() {}
        public Builder(ApplianceRfProfilesPerSsidSettingsStatus1 defaults) {
        ...
        public ApplianceRfProfilesPerSsidSettingsStatus1 build() {
            final var _resultValue = new ApplianceRfProfilesPerSsidSettingsStatus1();
