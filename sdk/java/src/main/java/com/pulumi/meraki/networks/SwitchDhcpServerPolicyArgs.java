...
public final class SwitchDhcpServerPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final SwitchDhcpServerPolicyArgs Empty = new SwitchDhcpServerPolicyArgs();
    ...
    private SwitchDhcpServerPolicyArgs() {}

    private SwitchDhcpServerPolicyArgs(SwitchDhcpServerPolicyArgs $) {
        this.alerts = $.alerts;
    ...
    public static Builder builder(SwitchDhcpServerPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchDhcpServerPolicyArgs();
        }

        public Builder(SwitchDhcpServerPolicyArgs defaults) {
            $ = new SwitchDhcpServerPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SwitchDhcpServerPolicyArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("SwitchDhcpServerPolicyArgs", "networkId");
            }
            return $;
        }
    }
