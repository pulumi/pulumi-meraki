...
@CustomType
public final class SmDevicesShutdownParameters {
    /**
    ...
    public static Builder builder(SmDevicesShutdownParameters defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> wifiMacs;
        public Builder() {}
        public Builder(SmDevicesShutdownParameters defaults) {
        ...
        public SmDevicesShutdownParameters build() {
            final var _resultValue = new SmDevicesShutdownParameters();
