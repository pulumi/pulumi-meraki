...
public final class GetSwitchDhcpV4ServersSeenArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSwitchDhcpV4ServersSeenArgs Empty = new GetSwitchDhcpV4ServersSeenArgs();
    ...
    private GetSwitchDhcpV4ServersSeenArgs() {}

    private GetSwitchDhcpV4ServersSeenArgs(GetSwitchDhcpV4ServersSeenArgs $) {
    ...
    public static Builder builder(GetSwitchDhcpV4ServersSeenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSwitchDhcpV4ServersSeenArgs();
        }

        public Builder(GetSwitchDhcpV4ServersSeenArgs defaults) {
            $ = new GetSwitchDhcpV4ServersSeenArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSwitchDhcpV4ServersSeenArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("GetSwitchDhcpV4ServersSeenArgs", "networkId");
            }
            return $;
        }
    }
