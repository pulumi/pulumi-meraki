...
import com.pulumi.meraki.devices.outputs.GetSwitchRoutingInterfacesDhcpItemDhcpOption;
import com.pulumi.meraki.devices.outputs.GetSwitchRoutingInterfacesDhcpItemFixedIpAssignment;
import com.pulumi.meraki.devices.outputs.GetSwitchRoutingInterfacesDhcpItemReservedIpRange;
...
@CustomType
public final class GetSwitchRoutingInterfacesDhcpItem {
    /**
     ...
     * 
     */
    private List<GetSwitchRoutingInterfacesDhcpItemDhcpOption> dhcpOptions;
    /**
     ...
     * 
     */
    private List<GetSwitchRoutingInterfacesDhcpItemFixedIpAssignment> fixedIpAssignments;
    /**
     * @return Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
     * 
     */
    private List<GetSwitchRoutingInterfacesDhcpItemReservedIpRange> reservedIpRanges;

    private GetSwitchRoutingInterfacesDhcpItem() {}
    /**
     * @return The PXE boot server file name for the DHCP server running on the switch stack interface
     * 
     */
     ...
     * 
     */
    public List<GetSwitchRoutingInterfacesDhcpItemDhcpOption> dhcpOptions() {
     ...
     * 
     */
    public List<GetSwitchRoutingInterfacesDhcpItemFixedIpAssignment> fixedIpAssignments() {
     ...
     * 
     */
    public List<GetSwitchRoutingInterfacesDhcpItemReservedIpRange> reservedIpRanges() {
    ...
    public static Builder builder(GetSwitchRoutingInterfacesDhcpItem defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetSwitchRoutingInterfacesDhcpItemReservedIpRange> reservedIpRanges;
        public Builder() {}
        public Builder(GetSwitchRoutingInterfacesDhcpItem defaults) {
        ...
        public Builder bootFileName(String bootFileName) {
            if (bootFileName == null) {
              throw new MissingRequiredPropertyException("GetSwitchRoutingInterfacesDhcpItem", "bootFileName");
            }
        ...
        public Builder bootNextServer(String bootNextServer) {
            if (bootNextServer == null) {
              throw new MissingRequiredPropertyException("GetSwitchRoutingInterfacesDhcpItem", "bootNextServer");
            }
        ...
        public Builder bootOptionsEnabled(Boolean bootOptionsEnabled) {
            if (bootOptionsEnabled == null) {
              throw new MissingRequiredPropertyException("GetSwitchRoutingInterfacesDhcpItem", "bootOptionsEnabled");
            }
        ...
        public Builder dhcpLeaseTime(String dhcpLeaseTime) {
            if (dhcpLeaseTime == null) {
              throw new MissingRequiredPropertyException("GetSwitchRoutingInterfacesDhcpItem", "dhcpLeaseTime");
            }
        ...
        public Builder dhcpMode(String dhcpMode) {
            if (dhcpMode == null) {
              throw new MissingRequiredPropertyException("GetSwitchRoutingInterfacesDhcpItem", "dhcpMode");
            }
            this.dhcpMode = dhcpMode;
            return this;
        }
        @CustomType.Setter
        public Builder dhcpOptions(List<GetSwitchRoutingInterfacesDhcpItemDhcpOption> dhcpOptions) {
            if (dhcpOptions == null) {
              throw new MissingRequiredPropertyException("GetSwitchRoutingInterfacesDhcpItem", "dhcpOptions");
            }
            this.dhcpOptions = dhcpOptions;
            return this;
        }
        public Builder dhcpOptions(GetSwitchRoutingInterfacesDhcpItemDhcpOption... dhcpOptions) {
        ...
        public Builder dhcpRelayServerIps(List<String> dhcpRelayServerIps) {
            if (dhcpRelayServerIps == null) {
              throw new MissingRequiredPropertyException("GetSwitchRoutingInterfacesDhcpItem", "dhcpRelayServerIps");
            }
        ...
        public Builder dnsCustomNameservers(List<String> dnsCustomNameservers) {
            if (dnsCustomNameservers == null) {
              throw new MissingRequiredPropertyException("GetSwitchRoutingInterfacesDhcpItem", "dnsCustomNameservers");
            }
        ...
        public Builder dnsNameserversOption(String dnsNameserversOption) {
            if (dnsNameserversOption == null) {
              throw new MissingRequiredPropertyException("GetSwitchRoutingInterfacesDhcpItem", "dnsNameserversOption");
            }
            this.dnsNameserversOption = dnsNameserversOption;
            return this;
        }
        @CustomType.Setter
        public Builder fixedIpAssignments(List<GetSwitchRoutingInterfacesDhcpItemFixedIpAssignment> fixedIpAssignments) {
            if (fixedIpAssignments == null) {
              throw new MissingRequiredPropertyException("GetSwitchRoutingInterfacesDhcpItem", "fixedIpAssignments");
            }
            this.fixedIpAssignments = fixedIpAssignments;
            return this;
        }
        public Builder fixedIpAssignments(GetSwitchRoutingInterfacesDhcpItemFixedIpAssignment... fixedIpAssignments) {
            return fixedIpAssignments(List.of(fixedIpAssignments));
        }
        @CustomType.Setter
        public Builder reservedIpRanges(List<GetSwitchRoutingInterfacesDhcpItemReservedIpRange> reservedIpRanges) {
            if (reservedIpRanges == null) {
              throw new MissingRequiredPropertyException("GetSwitchRoutingInterfacesDhcpItem", "reservedIpRanges");
            }
            this.reservedIpRanges = reservedIpRanges;
            return this;
        }
        public Builder reservedIpRanges(GetSwitchRoutingInterfacesDhcpItemReservedIpRange... reservedIpRanges) {
            return reservedIpRanges(List.of(reservedIpRanges));
        }
        public GetSwitchRoutingInterfacesDhcpItem build() {
            final var _resultValue = new GetSwitchRoutingInterfacesDhcpItem();
