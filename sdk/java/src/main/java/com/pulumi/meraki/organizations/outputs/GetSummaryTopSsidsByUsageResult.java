...
import com.pulumi.meraki.organizations.outputs.GetSummaryTopSsidsByUsageItem;
...
@CustomType
public final class GetSummaryTopSsidsByUsageResult {
    /**
    ...
    private String id;
    /**
     * @return Array of ResponseOrganizationsGetOrganizationSummaryTopSsidsByUsage
     * 
     */
    private List<GetSummaryTopSsidsByUsageItem> items;
    /**
     ...
     * 
     */
    public List<GetSummaryTopSsidsByUsageItem> items() {
        return this.items;
    }
    /**
     * @return organizationId path parameter. Organization ID
    ...
    public static Builder builder(GetSummaryTopSsidsByUsageResult defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double timespan;
        public Builder() {}
        public Builder(GetSummaryTopSsidsByUsageResult defaults) {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetSummaryTopSsidsByUsageResult", "id");
            }
            this.id = id;
            return this;
        }
        @CustomType.Setter
        public Builder items(List<GetSummaryTopSsidsByUsageItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetSummaryTopSsidsByUsageResult", "items");
            }
            this.items = items;
            return this;
        }
        public Builder items(GetSummaryTopSsidsByUsageItem... items) {
            return items(List.of(items));
        }
        @CustomType.Setter
        public Builder organizationId(String organizationId) {
            if (organizationId == null) {
              throw new MissingRequiredPropertyException("GetSummaryTopSsidsByUsageResult", "organizationId");
            }
        ...
        public GetSummaryTopSsidsByUsageResult build() {
            final var _resultValue = new GetSummaryTopSsidsByUsageResult();
            _resultValue.id = id;
