...
public final class WirelessRfProfilesPerSsidSettingsStatus11Args extends com.pulumi.resources.ResourceArgs {

    public static final WirelessRfProfilesPerSsidSettingsStatus11Args Empty = new WirelessRfProfilesPerSsidSettingsStatus11Args();
     ...
     */
    @Import(name="bands")
    private @Nullable Output<WirelessRfProfilesPerSsidSettingsStatus11BandsArgs> bands;

    /**
     * @return Settings related to all bands
     * 
     */
    public Optional<Output<WirelessRfProfilesPerSsidSettingsStatus11BandsArgs>> bands() {
    ...
    private WirelessRfProfilesPerSsidSettingsStatus11Args() {}

    private WirelessRfProfilesPerSsidSettingsStatus11Args(WirelessRfProfilesPerSsidSettingsStatus11Args $) {
    ...
    public static Builder builder(WirelessRfProfilesPerSsidSettingsStatus11Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessRfProfilesPerSsidSettingsStatus11Args();
        }

        public Builder(WirelessRfProfilesPerSsidSettingsStatus11Args defaults) {
            $ = new WirelessRfProfilesPerSsidSettingsStatus11Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder bands(@Nullable Output<WirelessRfProfilesPerSsidSettingsStatus11BandsArgs> bands) {
            $.bands = bands;
            return this;
        }
         ...
         * 
         */
        public Builder bands(WirelessRfProfilesPerSsidSettingsStatus11BandsArgs bands) {
        ...
        public WirelessRfProfilesPerSsidSettingsStatus11Args build() {
            return $;
        }
    }
