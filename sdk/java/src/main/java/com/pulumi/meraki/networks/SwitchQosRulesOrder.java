...
public class SwitchQosRulesOrder extends com.pulumi.resources.CustomResource {
    ...
    public SwitchQosRulesOrder(String name, SwitchQosRulesOrderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/switchQosRulesOrder:SwitchQosRulesOrder", name, args == null ? SwitchQosRulesOrderArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
