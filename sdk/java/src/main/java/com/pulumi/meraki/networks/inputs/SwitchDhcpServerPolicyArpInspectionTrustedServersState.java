...
public final class SwitchDhcpServerPolicyArpInspectionTrustedServersState extends com.pulumi.resources.ResourceArgs {

    public static final SwitchDhcpServerPolicyArpInspectionTrustedServersState Empty = new SwitchDhcpServerPolicyArpInspectionTrustedServersState();
    ...
    private SwitchDhcpServerPolicyArpInspectionTrustedServersState() {}

    private SwitchDhcpServerPolicyArpInspectionTrustedServersState(SwitchDhcpServerPolicyArpInspectionTrustedServersState $) {
        this.ipv4 = $.ipv4;
        this.mac = $.mac;
    ...
    public static Builder builder(SwitchDhcpServerPolicyArpInspectionTrustedServersState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchDhcpServerPolicyArpInspectionTrustedServersState();
        }

        public Builder(SwitchDhcpServerPolicyArpInspectionTrustedServersState defaults) {
            $ = new SwitchDhcpServerPolicyArpInspectionTrustedServersState(Objects.requireNonNull(defaults));
        }
        ...
        public SwitchDhcpServerPolicyArpInspectionTrustedServersState build() {
            return $;
        }
    }
