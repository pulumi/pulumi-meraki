 ...
 *                     .participateInNextBetaRelease(false)
 *                     .build())
 *                 .cellular_gateway(Map.ofEntries(
 *                     Map.entry("nextUpgrade", Map.ofEntries(
 *                         Map.entry("time", "2019-03-17T17:22:52Z"),
 *                         Map.entry("toVersion", Map.of("id", "1004"))
 *                     )),
 *                     Map.entry("participateInNextBetaRelease", false)
 *                 ))
 ...
 *                     .participateInNextBetaRelease(false)
 *                     .build())
 *                 .switch_catalyst(Map.ofEntries(
 *                     Map.entry("nextUpgrade", Map.ofEntries(
 *                         Map.entry("time", "2019-03-17T17:22:52Z"),
 *                         Map.entry("toVersion", Map.of("id", "1234"))
 *                     )),
 *                     Map.entry("participateInNextBetaRelease", false)
 *                 ))
