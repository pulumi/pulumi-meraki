...
public final class SensorAlertsProfilesConditionThresholdPm25Args extends com.pulumi.resources.ResourceArgs {

    public static final SensorAlertsProfilesConditionThresholdPm25Args Empty = new SensorAlertsProfilesConditionThresholdPm25Args();
    ...
    private SensorAlertsProfilesConditionThresholdPm25Args() {}

    private SensorAlertsProfilesConditionThresholdPm25Args(SensorAlertsProfilesConditionThresholdPm25Args $) {
    ...
    public static Builder builder(SensorAlertsProfilesConditionThresholdPm25Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SensorAlertsProfilesConditionThresholdPm25Args();
        }

        public Builder(SensorAlertsProfilesConditionThresholdPm25Args defaults) {
            $ = new SensorAlertsProfilesConditionThresholdPm25Args(Objects.requireNonNull(defaults));
        }
        ...
        public SensorAlertsProfilesConditionThresholdPm25Args build() {
            return $;
        }
    }
