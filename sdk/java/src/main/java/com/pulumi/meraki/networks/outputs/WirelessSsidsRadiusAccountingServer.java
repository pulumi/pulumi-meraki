...
@CustomType
public final class WirelessSsidsRadiusAccountingServer {
    /**
    ...
    public static Builder builder(WirelessSsidsRadiusAccountingServer defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String secret;
        public Builder() {}
        public Builder(WirelessSsidsRadiusAccountingServer defaults) {
        ...
        public WirelessSsidsRadiusAccountingServer build() {
            final var _resultValue = new WirelessSsidsRadiusAccountingServer();
