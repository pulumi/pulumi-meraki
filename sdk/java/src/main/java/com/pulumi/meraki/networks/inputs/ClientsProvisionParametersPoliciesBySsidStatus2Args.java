...
public final class ClientsProvisionParametersPoliciesBySsidStatus2Args extends com.pulumi.resources.ResourceArgs {

    public static final ClientsProvisionParametersPoliciesBySsidStatus2Args Empty = new ClientsProvisionParametersPoliciesBySsidStatus2Args();
    ...
    private ClientsProvisionParametersPoliciesBySsidStatus2Args() {}

    private ClientsProvisionParametersPoliciesBySsidStatus2Args(ClientsProvisionParametersPoliciesBySsidStatus2Args $) {
    ...
    public static Builder builder(ClientsProvisionParametersPoliciesBySsidStatus2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus2Args();
        }

        public Builder(ClientsProvisionParametersPoliciesBySsidStatus2Args defaults) {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus2Args(Objects.requireNonNull(defaults));
        }
        ...
        public ClientsProvisionParametersPoliciesBySsidStatus2Args build() {
            return $;
        }
    }
