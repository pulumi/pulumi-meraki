...
public final class WirelessRfProfilesPerSsidSettingsStatus2Args extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="bands")
    private @Nullable Output<WirelessRfProfilesPerSsidSettingsStatus2BandsArgs> bands;

    /**
     * @return Settings related to all bands
     * 
     */
    public Optional<Output<WirelessRfProfilesPerSsidSettingsStatus2BandsArgs>> bands() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder bands(@Nullable Output<WirelessRfProfilesPerSsidSettingsStatus2BandsArgs> bands) {
            $.bands = bands;
            return this;
        }
