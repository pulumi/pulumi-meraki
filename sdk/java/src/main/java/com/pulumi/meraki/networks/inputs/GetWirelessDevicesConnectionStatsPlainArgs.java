...
public final class GetWirelessDevicesConnectionStatsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetWirelessDevicesConnectionStatsPlainArgs Empty = new GetWirelessDevicesConnectionStatsPlainArgs();
    ...
    private GetWirelessDevicesConnectionStatsPlainArgs() {}

    private GetWirelessDevicesConnectionStatsPlainArgs(GetWirelessDevicesConnectionStatsPlainArgs $) {
        this.apTag = $.apTag;
        this.band = $.band;
    ...
    public static Builder builder(GetWirelessDevicesConnectionStatsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetWirelessDevicesConnectionStatsPlainArgs();
        }

        public Builder(GetWirelessDevicesConnectionStatsPlainArgs defaults) {
            $ = new GetWirelessDevicesConnectionStatsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetWirelessDevicesConnectionStatsPlainArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("GetWirelessDevicesConnectionStatsPlainArgs", "networkId");
            }
            return $;
        }
    }
