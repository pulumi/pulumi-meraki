...
import com.pulumi.meraki.networks.outputs.GetWirelessDataRateHistoryItem;
...
@CustomType
public final class GetWirelessDataRateHistoryResult {
    /**
     ...
     * 
     */
    public List<GetWirelessDataRateHistoryItem> items() {
        return this.items;
    }
    /**
     * @return networkId path parameter. Network ID
    ...
    public static Builder builder(GetWirelessDataRateHistoryResult defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double timespan;
        public Builder() {}
        public Builder(GetWirelessDataRateHistoryResult defaults) {
        ...
        @CustomType.Setter
        public Builder items(List<GetWirelessDataRateHistoryItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetWirelessDataRateHistoryResult", "items");
            }
            this.items = items;
            return this;
        }
        public Builder items(GetWirelessDataRateHistoryItem... items) {
            return items(List.of(items));
        }
        @CustomType.Setter
        public Builder networkId(String networkId) {
            if (networkId == null) {
              throw new MissingRequiredPropertyException("GetWirelessDataRateHistoryResult", "networkId");
            }
        ...
        public GetWirelessDataRateHistoryResult build() {
            final var _resultValue = new GetWirelessDataRateHistoryResult();
