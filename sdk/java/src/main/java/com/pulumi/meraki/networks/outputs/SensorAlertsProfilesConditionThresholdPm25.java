...
@CustomType
public final class SensorAlertsProfilesConditionThresholdPm25 {
    /**
    ...
    private SensorAlertsProfilesConditionThresholdPm25() {}
    /**
     * @return Alerting threshold as PM2.5 parts per million.
     * 
     */
    ...
    public static Builder builder(SensorAlertsProfilesConditionThresholdPm25 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String quality;
        public Builder() {}
        public Builder(SensorAlertsProfilesConditionThresholdPm25 defaults) {
        ...
        public SensorAlertsProfilesConditionThresholdPm25 build() {
            final var _resultValue = new SensorAlertsProfilesConditionThresholdPm25();
