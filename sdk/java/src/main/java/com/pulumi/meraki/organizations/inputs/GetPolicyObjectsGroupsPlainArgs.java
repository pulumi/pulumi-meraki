...
public final class GetPolicyObjectsGroupsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetPolicyObjectsGroupsPlainArgs Empty = new GetPolicyObjectsGroupsPlainArgs();
    ...
    private GetPolicyObjectsGroupsPlainArgs() {}

    private GetPolicyObjectsGroupsPlainArgs(GetPolicyObjectsGroupsPlainArgs $) {
    ...
    public static Builder builder(GetPolicyObjectsGroupsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPolicyObjectsGroupsPlainArgs();
        }

        public Builder(GetPolicyObjectsGroupsPlainArgs defaults) {
            $ = new GetPolicyObjectsGroupsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param perPage perPage query parameter. The number of entries per page returned. Acceptable range is 10 1000. Default is 1000.
         * 
         * @return builder
         * 
         */
        ...
        public GetPolicyObjectsGroupsPlainArgs build() {
            return $;
        }
    }
