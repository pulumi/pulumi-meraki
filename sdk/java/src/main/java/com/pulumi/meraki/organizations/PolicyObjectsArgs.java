...
public final class PolicyObjectsArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyObjectsArgs Empty = new PolicyObjectsArgs();
    ...
    private PolicyObjectsArgs() {}

    private PolicyObjectsArgs(PolicyObjectsArgs $) {
    ...
    public static Builder builder(PolicyObjectsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyObjectsArgs();
        }

        public Builder(PolicyObjectsArgs defaults) {
            $ = new PolicyObjectsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyObjectsArgs build() {
            if ($.organizationId == null) {
                throw new MissingRequiredPropertyException("PolicyObjectsArgs", "organizationId");
            }
            return $;
        }
    }
