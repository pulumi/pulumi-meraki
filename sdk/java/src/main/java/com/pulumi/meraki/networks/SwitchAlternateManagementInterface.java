...
public class SwitchAlternateManagementInterface extends com.pulumi.resources.CustomResource {
     ...
     */
    public SwitchAlternateManagementInterface(java.lang.String name) {
     ...
     */
    public SwitchAlternateManagementInterface(java.lang.String name, SwitchAlternateManagementInterfaceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SwitchAlternateManagementInterface(java.lang.String name, SwitchAlternateManagementInterfaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/switchAlternateManagementInterface:SwitchAlternateManagementInterface", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SwitchAlternateManagementInterface(java.lang.String name, Output<java.lang.String> id, @Nullable SwitchAlternateManagementInterfaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/switchAlternateManagementInterface:SwitchAlternateManagementInterface", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static SwitchAlternateManagementInterface get(java.lang.String name, Output<java.lang.String> id, @Nullable SwitchAlternateManagementInterfaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
