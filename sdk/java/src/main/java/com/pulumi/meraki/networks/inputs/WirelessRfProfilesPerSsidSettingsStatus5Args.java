...
public final class WirelessRfProfilesPerSsidSettingsStatus5Args extends com.pulumi.resources.ResourceArgs {

    public static final WirelessRfProfilesPerSsidSettingsStatus5Args Empty = new WirelessRfProfilesPerSsidSettingsStatus5Args();
     ...
     */
    @Import(name="bands")
    private @Nullable Output<WirelessRfProfilesPerSsidSettingsStatus5BandsArgs> bands;

    /**
     * @return Settings related to all bands
     * 
     */
    public Optional<Output<WirelessRfProfilesPerSsidSettingsStatus5BandsArgs>> bands() {
    ...
    private WirelessRfProfilesPerSsidSettingsStatus5Args() {}

    private WirelessRfProfilesPerSsidSettingsStatus5Args(WirelessRfProfilesPerSsidSettingsStatus5Args $) {
    ...
    public static Builder builder(WirelessRfProfilesPerSsidSettingsStatus5Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessRfProfilesPerSsidSettingsStatus5Args();
        }

        public Builder(WirelessRfProfilesPerSsidSettingsStatus5Args defaults) {
            $ = new WirelessRfProfilesPerSsidSettingsStatus5Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder bands(@Nullable Output<WirelessRfProfilesPerSsidSettingsStatus5BandsArgs> bands) {
            $.bands = bands;
            return this;
        }
         ...
         * 
         */
        public Builder bands(WirelessRfProfilesPerSsidSettingsStatus5BandsArgs bands) {
        ...
        public WirelessRfProfilesPerSsidSettingsStatus5Args build() {
            return $;
        }
    }
