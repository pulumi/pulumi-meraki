...
public final class WirelessRfProfilesPerSsidSettingsStatus13Args extends com.pulumi.resources.ResourceArgs {

    public static final WirelessRfProfilesPerSsidSettingsStatus13Args Empty = new WirelessRfProfilesPerSsidSettingsStatus13Args();
     ...
     */
    @Import(name="bands")
    private @Nullable Output<WirelessRfProfilesPerSsidSettingsStatus13BandsArgs> bands;

    /**
     * @return Settings related to all bands
     * 
     */
    public Optional<Output<WirelessRfProfilesPerSsidSettingsStatus13BandsArgs>> bands() {
    ...
    private WirelessRfProfilesPerSsidSettingsStatus13Args() {}

    private WirelessRfProfilesPerSsidSettingsStatus13Args(WirelessRfProfilesPerSsidSettingsStatus13Args $) {
    ...
    public static Builder builder(WirelessRfProfilesPerSsidSettingsStatus13Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessRfProfilesPerSsidSettingsStatus13Args();
        }

        public Builder(WirelessRfProfilesPerSsidSettingsStatus13Args defaults) {
            $ = new WirelessRfProfilesPerSsidSettingsStatus13Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder bands(@Nullable Output<WirelessRfProfilesPerSsidSettingsStatus13BandsArgs> bands) {
            $.bands = bands;
            return this;
        }
         ...
         * 
         */
        public Builder bands(WirelessRfProfilesPerSsidSettingsStatus13BandsArgs bands) {
        ...
        public WirelessRfProfilesPerSsidSettingsStatus13Args build() {
            return $;
        }
    }
