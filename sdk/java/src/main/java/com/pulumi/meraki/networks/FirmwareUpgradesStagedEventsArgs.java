...
public final class FirmwareUpgradesStagedEventsArgs extends com.pulumi.resources.ResourceArgs {

    public static final FirmwareUpgradesStagedEventsArgs Empty = new FirmwareUpgradesStagedEventsArgs();
    ...
    private FirmwareUpgradesStagedEventsArgs() {}

    private FirmwareUpgradesStagedEventsArgs(FirmwareUpgradesStagedEventsArgs $) {
    ...
    public static Builder builder(FirmwareUpgradesStagedEventsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirmwareUpgradesStagedEventsArgs();
        }

        public Builder(FirmwareUpgradesStagedEventsArgs defaults) {
            $ = new FirmwareUpgradesStagedEventsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FirmwareUpgradesStagedEventsArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("FirmwareUpgradesStagedEventsArgs", "networkId");
            }
            return $;
        }
    }
