...
public final class ClientsProvisionParametersPoliciesBySsidStatus13Args extends com.pulumi.resources.ResourceArgs {

    public static final ClientsProvisionParametersPoliciesBySsidStatus13Args Empty = new ClientsProvisionParametersPoliciesBySsidStatus13Args();
    ...
    private ClientsProvisionParametersPoliciesBySsidStatus13Args() {}

    private ClientsProvisionParametersPoliciesBySsidStatus13Args(ClientsProvisionParametersPoliciesBySsidStatus13Args $) {
    ...
    public static Builder builder(ClientsProvisionParametersPoliciesBySsidStatus13Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus13Args();
        }

        public Builder(ClientsProvisionParametersPoliciesBySsidStatus13Args defaults) {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus13Args(Objects.requireNonNull(defaults));
        }
        ...
        public ClientsProvisionParametersPoliciesBySsidStatus13Args build() {
            return $;
        }
    }
