...
@CustomType
public final class SmDevicesLockParameters {
    /**
    ...
    public static Builder builder(SmDevicesLockParameters defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> wifiMacs;
        public Builder() {}
        public Builder(SmDevicesLockParameters defaults) {
        ...
        public SmDevicesLockParameters build() {
            final var _resultValue = new SmDevicesLockParameters();
