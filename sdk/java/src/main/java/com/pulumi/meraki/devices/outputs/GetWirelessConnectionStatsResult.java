...
import com.pulumi.meraki.devices.outputs.GetWirelessConnectionStatsItem;
...
public final class GetWirelessConnectionStatsResult {
    ...
    public static final class Builder {
        ...
        public Builder serial(String serial) {
            if (serial == null) {
              throw new MissingRequiredPropertyException("GetWirelessConnectionStatsResult", "serial");
            }
            this.serial = serial;
            return this;
        }
