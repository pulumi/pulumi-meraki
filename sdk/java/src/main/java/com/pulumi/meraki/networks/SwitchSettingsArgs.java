...
public final class SwitchSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final SwitchSettingsArgs Empty = new SwitchSettingsArgs();
    ...
    private SwitchSettingsArgs() {}

    private SwitchSettingsArgs(SwitchSettingsArgs $) {
    ...
    public static Builder builder(SwitchSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchSettingsArgs();
        }

        public Builder(SwitchSettingsArgs defaults) {
            $ = new SwitchSettingsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SwitchSettingsArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("SwitchSettingsArgs", "networkId");
            }
            return $;
        }
    }
