...
public final class GetWirelessFailedConnectionsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetWirelessFailedConnectionsPlainArgs Empty = new GetWirelessFailedConnectionsPlainArgs();
    ...
    private GetWirelessFailedConnectionsPlainArgs() {}

    private GetWirelessFailedConnectionsPlainArgs(GetWirelessFailedConnectionsPlainArgs $) {
        this.apTag = $.apTag;
        this.band = $.band;
    ...
    public static Builder builder(GetWirelessFailedConnectionsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetWirelessFailedConnectionsPlainArgs();
        }

        public Builder(GetWirelessFailedConnectionsPlainArgs defaults) {
            $ = new GetWirelessFailedConnectionsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetWirelessFailedConnectionsPlainArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("GetWirelessFailedConnectionsPlainArgs", "networkId");
            }
            return $;
        }
    }
