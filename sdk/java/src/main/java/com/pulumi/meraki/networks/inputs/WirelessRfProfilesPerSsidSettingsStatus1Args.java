...
public final class WirelessRfProfilesPerSsidSettingsStatus1Args extends com.pulumi.resources.ResourceArgs {

    public static final WirelessRfProfilesPerSsidSettingsStatus1Args Empty = new WirelessRfProfilesPerSsidSettingsStatus1Args();
     ...
     */
    @Import(name="bands")
    private @Nullable Output<WirelessRfProfilesPerSsidSettingsStatus1BandsArgs> bands;

    /**
     * @return Settings related to all bands
     * 
     */
    public Optional<Output<WirelessRfProfilesPerSsidSettingsStatus1BandsArgs>> bands() {
    ...
    private WirelessRfProfilesPerSsidSettingsStatus1Args() {}

    private WirelessRfProfilesPerSsidSettingsStatus1Args(WirelessRfProfilesPerSsidSettingsStatus1Args $) {
    ...
    public static Builder builder(WirelessRfProfilesPerSsidSettingsStatus1Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessRfProfilesPerSsidSettingsStatus1Args();
        }

        public Builder(WirelessRfProfilesPerSsidSettingsStatus1Args defaults) {
            $ = new WirelessRfProfilesPerSsidSettingsStatus1Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder bands(@Nullable Output<WirelessRfProfilesPerSsidSettingsStatus1BandsArgs> bands) {
            $.bands = bands;
            return this;
        }
         ...
         * 
         */
        public Builder bands(WirelessRfProfilesPerSsidSettingsStatus1BandsArgs bands) {
        ...
        public WirelessRfProfilesPerSsidSettingsStatus1Args build() {
            return $;
        }
    }
