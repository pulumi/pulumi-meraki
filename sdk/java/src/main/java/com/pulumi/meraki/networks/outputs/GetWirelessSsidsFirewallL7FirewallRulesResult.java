...
import com.pulumi.meraki.networks.outputs.GetWirelessSsidsFirewallL7FirewallRulesItem;
...
public final class GetWirelessSsidsFirewallL7FirewallRulesResult {
    ...
    public static Builder builder(GetWirelessSsidsFirewallL7FirewallRulesResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder item(GetWirelessSsidsFirewallL7FirewallRulesItem item) {
            if (item == null) {
              throw new MissingRequiredPropertyException("GetWirelessSsidsFirewallL7FirewallRulesResult", "item");
            }
            this.item = item;
            return this;
        }
        ...
        public Builder networkId(String networkId) {
            if (networkId == null) {
              throw new MissingRequiredPropertyException("GetWirelessSsidsFirewallL7FirewallRulesResult", "networkId");
            }
        ...
        public Builder number(String number) {
            if (number == null) {
              throw new MissingRequiredPropertyException("GetWirelessSsidsFirewallL7FirewallRulesResult", "number");
            }
            this.number = number;
            return this;
        }
