...
@CustomType
public final class ApplianceVpnThirdPartyVpnpeersPeersResponseIpsecPolicies {
    /**
    ...
    private ApplianceVpnThirdPartyVpnpeersPeersResponseIpsecPolicies() {}
    /**
     * @return This is the authentication algorithms to be used in Phase 2. The value should be an array with one of the following algorithms: &#39;sha256&#39;, &#39;sha1&#39;, &#39;md5&#39;
     * 
     */
    ...
    public static Builder builder(ApplianceVpnThirdPartyVpnpeersPeersResponseIpsecPolicies defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> ikePrfAlgos;
        public Builder() {}
        public Builder(ApplianceVpnThirdPartyVpnpeersPeersResponseIpsecPolicies defaults) {
        ...
        public ApplianceVpnThirdPartyVpnpeersPeersResponseIpsecPolicies build() {
            final var _resultValue = new ApplianceVpnThirdPartyVpnpeersPeersResponseIpsecPolicies();
