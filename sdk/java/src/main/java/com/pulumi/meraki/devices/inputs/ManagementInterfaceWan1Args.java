...
public final class ManagementInterfaceWan1Args extends com.pulumi.resources.ResourceArgs {

    public static final ManagementInterfaceWan1Args Empty = new ManagementInterfaceWan1Args();
    ...
    private ManagementInterfaceWan1Args() {}

    private ManagementInterfaceWan1Args(ManagementInterfaceWan1Args $) {
    ...
    public static Builder builder(ManagementInterfaceWan1Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagementInterfaceWan1Args();
        }

        public Builder(ManagementInterfaceWan1Args defaults) {
            $ = new ManagementInterfaceWan1Args(Objects.requireNonNull(defaults));
        }
        ...
        public ManagementInterfaceWan1Args build() {
            return $;
        }
    }
