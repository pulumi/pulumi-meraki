...
@CustomType
public final class AlertsSettingsDefaultDestinations {
    /**
    ...
    public static Builder builder(AlertsSettingsDefaultDestinations defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean snmp;
        public Builder() {}
        public Builder(AlertsSettingsDefaultDestinations defaults) {
        ...
        public AlertsSettingsDefaultDestinations build() {
            final var _resultValue = new AlertsSettingsDefaultDestinations();
