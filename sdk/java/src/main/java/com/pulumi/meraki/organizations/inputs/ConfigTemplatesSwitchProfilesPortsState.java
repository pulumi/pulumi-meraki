...
import com.pulumi.meraki.organizations.inputs.ConfigTemplatesSwitchProfilesPortsMirrorArgs;
import com.pulumi.meraki.organizations.inputs.ConfigTemplatesSwitchProfilesPortsModuleArgs;
...
public final class ConfigTemplatesSwitchProfilesPortsState extends com.pulumi.resources.ResourceArgs {

    public static final ConfigTemplatesSwitchProfilesPortsState Empty = new ConfigTemplatesSwitchProfilesPortsState();
    ...
    private @Nullable Output<List<String>> linkNegotiationCapabilities;

    /**
     * @return Available link speeds for the switch template port.
     * 
     */
    public Optional<Output<List<String>>> linkNegotiationCapabilities() {
     ...
     */
    @Import(name="mirror")
    private @Nullable Output<ConfigTemplatesSwitchProfilesPortsMirrorArgs> mirror;

    /**
     * @return Port mirror
     * 
     */
    public Optional<Output<ConfigTemplatesSwitchProfilesPortsMirrorArgs>> mirror() {
     ...
     */
    @Import(name="module")
    private @Nullable Output<ConfigTemplatesSwitchProfilesPortsModuleArgs> module;

    /**
     * @return Expansion module
     * 
     */
    public Optional<Output<ConfigTemplatesSwitchProfilesPortsModuleArgs>> module() {
    ...
    private ConfigTemplatesSwitchProfilesPortsState() {}

    private ConfigTemplatesSwitchProfilesPortsState(ConfigTemplatesSwitchProfilesPortsState $) {
    ...
    public static Builder builder(ConfigTemplatesSwitchProfilesPortsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConfigTemplatesSwitchProfilesPortsState();
        }

        public Builder(ConfigTemplatesSwitchProfilesPortsState defaults) {
            $ = new ConfigTemplatesSwitchProfilesPortsState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param linkNegotiationCapabilities Available link speeds for the switch template port.
         * 
         * @return builder
         * 
         */
        public Builder linkNegotiationCapabilities(@Nullable Output<List<String>> linkNegotiationCapabilities) {
         ...
         * 
         */
        public Builder mirror(@Nullable Output<ConfigTemplatesSwitchProfilesPortsMirrorArgs> mirror) {
            $.mirror = mirror;
            return this;
        }
         ...
         * 
         */
        public Builder mirror(ConfigTemplatesSwitchProfilesPortsMirrorArgs mirror) {
         ...
         * 
         */
        public Builder module(@Nullable Output<ConfigTemplatesSwitchProfilesPortsModuleArgs> module) {
            $.module = module;
            return this;
        }
         ...
         * 
         */
        public Builder module(ConfigTemplatesSwitchProfilesPortsModuleArgs module) {
        ...
        public ConfigTemplatesSwitchProfilesPortsState build() {
            return $;
        }
    }
