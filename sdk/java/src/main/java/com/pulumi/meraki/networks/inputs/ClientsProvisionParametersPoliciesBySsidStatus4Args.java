...
public final class ClientsProvisionParametersPoliciesBySsidStatus4Args extends com.pulumi.resources.ResourceArgs {

    public static final ClientsProvisionParametersPoliciesBySsidStatus4Args Empty = new ClientsProvisionParametersPoliciesBySsidStatus4Args();
    ...
    private ClientsProvisionParametersPoliciesBySsidStatus4Args() {}

    private ClientsProvisionParametersPoliciesBySsidStatus4Args(ClientsProvisionParametersPoliciesBySsidStatus4Args $) {
    ...
    public static Builder builder(ClientsProvisionParametersPoliciesBySsidStatus4Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus4Args();
        }

        public Builder(ClientsProvisionParametersPoliciesBySsidStatus4Args defaults) {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus4Args(Objects.requireNonNull(defaults));
        }
        ...
        public ClientsProvisionParametersPoliciesBySsidStatus4Args build() {
            return $;
        }
    }
