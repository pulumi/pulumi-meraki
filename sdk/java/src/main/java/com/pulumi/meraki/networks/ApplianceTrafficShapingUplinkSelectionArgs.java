...
public final class ApplianceTrafficShapingUplinkSelectionArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplianceTrafficShapingUplinkSelectionArgs Empty = new ApplianceTrafficShapingUplinkSelectionArgs();
    ...
    private ApplianceTrafficShapingUplinkSelectionArgs() {}

    private ApplianceTrafficShapingUplinkSelectionArgs(ApplianceTrafficShapingUplinkSelectionArgs $) {
    ...
    public static Builder builder(ApplianceTrafficShapingUplinkSelectionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplianceTrafficShapingUplinkSelectionArgs();
        }

        public Builder(ApplianceTrafficShapingUplinkSelectionArgs defaults) {
            $ = new ApplianceTrafficShapingUplinkSelectionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApplianceTrafficShapingUplinkSelectionArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("ApplianceTrafficShapingUplinkSelectionArgs", "networkId");
            }
            return $;
        }
    }
