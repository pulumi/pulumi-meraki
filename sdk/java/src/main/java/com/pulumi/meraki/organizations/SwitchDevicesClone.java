...
public class SwitchDevicesClone extends com.pulumi.resources.CustomResource {
    ...
    public SwitchDevicesClone(String name, SwitchDevicesCloneArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:organizations/switchDevicesClone:SwitchDevicesClone", name, args == null ? SwitchDevicesCloneArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
