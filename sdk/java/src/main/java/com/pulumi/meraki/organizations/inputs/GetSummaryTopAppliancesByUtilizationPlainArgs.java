...
public final class GetSummaryTopAppliancesByUtilizationPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSummaryTopAppliancesByUtilizationPlainArgs Empty = new GetSummaryTopAppliancesByUtilizationPlainArgs();
    ...
    private GetSummaryTopAppliancesByUtilizationPlainArgs() {}

    private GetSummaryTopAppliancesByUtilizationPlainArgs(GetSummaryTopAppliancesByUtilizationPlainArgs $) {
    ...
    public static Builder builder(GetSummaryTopAppliancesByUtilizationPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSummaryTopAppliancesByUtilizationPlainArgs();
        }

        public Builder(GetSummaryTopAppliancesByUtilizationPlainArgs defaults) {
            $ = new GetSummaryTopAppliancesByUtilizationPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSummaryTopAppliancesByUtilizationPlainArgs build() {
            if ($.organizationId == null) {
                throw new MissingRequiredPropertyException("GetSummaryTopAppliancesByUtilizationPlainArgs", "organizationId");
            }
            return $;
        }
    }
