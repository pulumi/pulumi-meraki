...
public final class GetSummaryTopSsidsByUsagePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSummaryTopSsidsByUsagePlainArgs Empty = new GetSummaryTopSsidsByUsagePlainArgs();
    ...
    private GetSummaryTopSsidsByUsagePlainArgs() {}

    private GetSummaryTopSsidsByUsagePlainArgs(GetSummaryTopSsidsByUsagePlainArgs $) {
    ...
    public static Builder builder(GetSummaryTopSsidsByUsagePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSummaryTopSsidsByUsagePlainArgs();
        }

        public Builder(GetSummaryTopSsidsByUsagePlainArgs defaults) {
            $ = new GetSummaryTopSsidsByUsagePlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSummaryTopSsidsByUsagePlainArgs build() {
            if ($.organizationId == null) {
                throw new MissingRequiredPropertyException("GetSummaryTopSsidsByUsagePlainArgs", "organizationId");
            }
            return $;
        }
    }
