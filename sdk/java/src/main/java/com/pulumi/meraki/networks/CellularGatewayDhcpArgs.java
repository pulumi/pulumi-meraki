...
public final class CellularGatewayDhcpArgs extends com.pulumi.resources.ResourceArgs {

    public static final CellularGatewayDhcpArgs Empty = new CellularGatewayDhcpArgs();
    ...
    private CellularGatewayDhcpArgs() {}

    private CellularGatewayDhcpArgs(CellularGatewayDhcpArgs $) {
    ...
    public static Builder builder(CellularGatewayDhcpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CellularGatewayDhcpArgs();
        }

        public Builder(CellularGatewayDhcpArgs defaults) {
            $ = new CellularGatewayDhcpArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CellularGatewayDhcpArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("CellularGatewayDhcpArgs", "networkId");
            }
            return $;
        }
    }
