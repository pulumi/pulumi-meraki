...
public final class ClientsProvisionParametersPoliciesBySsidStatus9Args extends com.pulumi.resources.ResourceArgs {

    public static final ClientsProvisionParametersPoliciesBySsidStatus9Args Empty = new ClientsProvisionParametersPoliciesBySsidStatus9Args();
    ...
    private ClientsProvisionParametersPoliciesBySsidStatus9Args() {}

    private ClientsProvisionParametersPoliciesBySsidStatus9Args(ClientsProvisionParametersPoliciesBySsidStatus9Args $) {
    ...
    public static Builder builder(ClientsProvisionParametersPoliciesBySsidStatus9Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus9Args();
        }

        public Builder(ClientsProvisionParametersPoliciesBySsidStatus9Args defaults) {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus9Args(Objects.requireNonNull(defaults));
        }
        ...
        public ClientsProvisionParametersPoliciesBySsidStatus9Args build() {
            return $;
        }
    }
