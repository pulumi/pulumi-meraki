...
public final class ClientsProvisionParametersPoliciesBySsidStatus1Args extends com.pulumi.resources.ResourceArgs {

    public static final ClientsProvisionParametersPoliciesBySsidStatus1Args Empty = new ClientsProvisionParametersPoliciesBySsidStatus1Args();
    ...
    private ClientsProvisionParametersPoliciesBySsidStatus1Args() {}

    private ClientsProvisionParametersPoliciesBySsidStatus1Args(ClientsProvisionParametersPoliciesBySsidStatus1Args $) {
    ...
    public static Builder builder(ClientsProvisionParametersPoliciesBySsidStatus1Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus1Args();
        }

        public Builder(ClientsProvisionParametersPoliciesBySsidStatus1Args defaults) {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus1Args(Objects.requireNonNull(defaults));
        }
        ...
        public ClientsProvisionParametersPoliciesBySsidStatus1Args build() {
            return $;
        }
    }
