...
@CustomType
public final class WirelessBillingPlanBandwidthLimits {
    /**
    ...
    private WirelessBillingPlanBandwidthLimits() {}
    /**
     * @return The maximum download limit (integer, in Kbps).
     * 
     */
    ...
    public static Builder builder(WirelessBillingPlanBandwidthLimits defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer limitUp;
        public Builder() {}
        public Builder(WirelessBillingPlanBandwidthLimits defaults) {
        ...
        public WirelessBillingPlanBandwidthLimits build() {
            final var _resultValue = new WirelessBillingPlanBandwidthLimits();
