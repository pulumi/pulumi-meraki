...
public final class ClientsProvisionParametersPoliciesBySsidStatus5Args extends com.pulumi.resources.ResourceArgs {

    public static final ClientsProvisionParametersPoliciesBySsidStatus5Args Empty = new ClientsProvisionParametersPoliciesBySsidStatus5Args();
    ...
    private ClientsProvisionParametersPoliciesBySsidStatus5Args() {}

    private ClientsProvisionParametersPoliciesBySsidStatus5Args(ClientsProvisionParametersPoliciesBySsidStatus5Args $) {
    ...
    public static Builder builder(ClientsProvisionParametersPoliciesBySsidStatus5Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus5Args();
        }

        public Builder(ClientsProvisionParametersPoliciesBySsidStatus5Args defaults) {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus5Args(Objects.requireNonNull(defaults));
        }
        ...
        public ClientsProvisionParametersPoliciesBySsidStatus5Args build() {
            return $;
        }
    }
