...
@CustomType
public final class WirelessSsidsBonjourForwardingRule {
    /**
    ...
    public static Builder builder(WirelessSsidsBonjourForwardingRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vlanId;
        public Builder() {}
        public Builder(WirelessSsidsBonjourForwardingRule defaults) {
        ...
        public WirelessSsidsBonjourForwardingRule build() {
            final var _resultValue = new WirelessSsidsBonjourForwardingRule();
