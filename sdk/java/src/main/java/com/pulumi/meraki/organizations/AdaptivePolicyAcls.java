...
public class AdaptivePolicyAcls extends com.pulumi.resources.CustomResource {
    ...
    public AdaptivePolicyAcls(String name, AdaptivePolicyAclsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:organizations/adaptivePolicyAcls:AdaptivePolicyAcls", name, args == null ? AdaptivePolicyAclsArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
