...
import com.pulumi.meraki.networks.outputs.GetSmTrustedAccessConfigsItem;
...
@CustomType
public final class GetSmTrustedAccessConfigsResult {
    /**
     ...
     * 
     */
    public List<GetSmTrustedAccessConfigsItem> items() {
        return this.items;
    }
    /**
     * @return networkId path parameter. Network ID
    ...
    public static Builder builder(GetSmTrustedAccessConfigsResult defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(List<GetSmTrustedAccessConfigsItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetSmTrustedAccessConfigsResult", "items");
            }
            this.items = items;
            return this;
        }
        public Builder items(GetSmTrustedAccessConfigsItem... items) {
            return items(List.of(items));
        }
        @CustomType.Setter
        public Builder networkId(String networkId) {
            if (networkId == null) {
              throw new MissingRequiredPropertyException("GetSmTrustedAccessConfigsResult", "networkId");
            }
