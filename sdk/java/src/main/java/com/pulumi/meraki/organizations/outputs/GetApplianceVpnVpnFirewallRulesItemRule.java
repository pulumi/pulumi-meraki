...
@CustomType
public final class GetApplianceVpnVpnFirewallRulesItemRule {
    /**
    ...
    private GetApplianceVpnVpnFirewallRulesItemRule() {}
    /**
     * @return Description of the rule (optional)
     * 
     */
    ...
    public static Builder builder(GetApplianceVpnVpnFirewallRulesItemRule defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean syslogEnabled;
        public Builder() {}
        public Builder(GetApplianceVpnVpnFirewallRulesItemRule defaults) {
        ...
        public Builder comment(String comment) {
            if (comment == null) {
              throw new MissingRequiredPropertyException("GetApplianceVpnVpnFirewallRulesItemRule", "comment");
            }
        ...
        public Builder destCidr(String destCidr) {
            if (destCidr == null) {
              throw new MissingRequiredPropertyException("GetApplianceVpnVpnFirewallRulesItemRule", "destCidr");
            }
        ...
        public Builder destPort(String destPort) {
            if (destPort == null) {
              throw new MissingRequiredPropertyException("GetApplianceVpnVpnFirewallRulesItemRule", "destPort");
            }
        ...
        public Builder policy(String policy) {
            if (policy == null) {
              throw new MissingRequiredPropertyException("GetApplianceVpnVpnFirewallRulesItemRule", "policy");
            }
            this.policy = policy;
            return this;
        }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetApplianceVpnVpnFirewallRulesItemRule", "protocol");
            }
        ...
        public Builder srcCidr(String srcCidr) {
            if (srcCidr == null) {
              throw new MissingRequiredPropertyException("GetApplianceVpnVpnFirewallRulesItemRule", "srcCidr");
            }
        ...
        public Builder srcPort(String srcPort) {
            if (srcPort == null) {
              throw new MissingRequiredPropertyException("GetApplianceVpnVpnFirewallRulesItemRule", "srcPort");
            }
        ...
        public Builder syslogEnabled(Boolean syslogEnabled) {
            if (syslogEnabled == null) {
              throw new MissingRequiredPropertyException("GetApplianceVpnVpnFirewallRulesItemRule", "syslogEnabled");
            }
            this.syslogEnabled = syslogEnabled;
            return this;
        }
        public GetApplianceVpnVpnFirewallRulesItemRule build() {
            final var _resultValue = new GetApplianceVpnVpnFirewallRulesItemRule();
