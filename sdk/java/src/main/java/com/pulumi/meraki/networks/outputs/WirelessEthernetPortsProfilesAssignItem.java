...
@CustomType
public final class WirelessEthernetPortsProfilesAssignItem {
    /**
    ...
    private WirelessEthernetPortsProfilesAssignItem() {}
    /**
     * @return AP profile ID
     * 
     */
    ...
    public static Builder builder(WirelessEthernetPortsProfilesAssignItem defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> serials;
        public Builder() {}
        public Builder(WirelessEthernetPortsProfilesAssignItem defaults) {
        ...
        public WirelessEthernetPortsProfilesAssignItem build() {
            final var _resultValue = new WirelessEthernetPortsProfilesAssignItem();
