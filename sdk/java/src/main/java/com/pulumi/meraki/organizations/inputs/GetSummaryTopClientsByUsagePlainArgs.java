...
public final class GetSummaryTopClientsByUsagePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSummaryTopClientsByUsagePlainArgs Empty = new GetSummaryTopClientsByUsagePlainArgs();
    ...
    private GetSummaryTopClientsByUsagePlainArgs() {}

    private GetSummaryTopClientsByUsagePlainArgs(GetSummaryTopClientsByUsagePlainArgs $) {
    ...
    public static Builder builder(GetSummaryTopClientsByUsagePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSummaryTopClientsByUsagePlainArgs();
        }

        public Builder(GetSummaryTopClientsByUsagePlainArgs defaults) {
            $ = new GetSummaryTopClientsByUsagePlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSummaryTopClientsByUsagePlainArgs build() {
            if ($.organizationId == null) {
                throw new MissingRequiredPropertyException("GetSummaryTopClientsByUsagePlainArgs", "organizationId");
            }
            return $;
        }
    }
