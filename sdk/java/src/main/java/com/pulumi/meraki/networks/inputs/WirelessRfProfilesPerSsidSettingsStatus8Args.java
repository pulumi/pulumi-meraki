...
public final class WirelessRfProfilesPerSsidSettingsStatus8Args extends com.pulumi.resources.ResourceArgs {

    public static final WirelessRfProfilesPerSsidSettingsStatus8Args Empty = new WirelessRfProfilesPerSsidSettingsStatus8Args();
     ...
     */
    @Import(name="bands")
    private @Nullable Output<WirelessRfProfilesPerSsidSettingsStatus8BandsArgs> bands;

    /**
     * @return Settings related to all bands
     * 
     */
    public Optional<Output<WirelessRfProfilesPerSsidSettingsStatus8BandsArgs>> bands() {
    ...
    private WirelessRfProfilesPerSsidSettingsStatus8Args() {}

    private WirelessRfProfilesPerSsidSettingsStatus8Args(WirelessRfProfilesPerSsidSettingsStatus8Args $) {
    ...
    public static Builder builder(WirelessRfProfilesPerSsidSettingsStatus8Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessRfProfilesPerSsidSettingsStatus8Args();
        }

        public Builder(WirelessRfProfilesPerSsidSettingsStatus8Args defaults) {
            $ = new WirelessRfProfilesPerSsidSettingsStatus8Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder bands(@Nullable Output<WirelessRfProfilesPerSsidSettingsStatus8BandsArgs> bands) {
            $.bands = bands;
            return this;
        }
         ...
         * 
         */
        public Builder bands(WirelessRfProfilesPerSsidSettingsStatus8BandsArgs bands) {
        ...
        public WirelessRfProfilesPerSsidSettingsStatus8Args build() {
            return $;
        }
    }
