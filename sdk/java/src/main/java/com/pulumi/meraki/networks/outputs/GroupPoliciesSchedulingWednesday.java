...
@CustomType
public final class GroupPoliciesSchedulingWednesday {
    /**
    ...
    private GroupPoliciesSchedulingWednesday() {}
    /**
     * @return Whether the schedule is active (true) or inactive (false) during the time specified between &#39;from&#39; and &#39;to&#39;. Defaults to true.
     * 
     */
    ...
    public static Builder builder(GroupPoliciesSchedulingWednesday defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String to;
        public Builder() {}
        public Builder(GroupPoliciesSchedulingWednesday defaults) {
        ...
        public GroupPoliciesSchedulingWednesday build() {
            final var _resultValue = new GroupPoliciesSchedulingWednesday();
