...
public class SwitchStacksRoutingStaticRoutes extends com.pulumi.resources.CustomResource {
    ...
    public SwitchStacksRoutingStaticRoutes(String name, SwitchStacksRoutingStaticRoutesArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/switchStacksRoutingStaticRoutes:SwitchStacksRoutingStaticRoutes", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
