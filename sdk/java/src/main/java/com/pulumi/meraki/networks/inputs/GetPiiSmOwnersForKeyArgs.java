...
public final class GetPiiSmOwnersForKeyArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetPiiSmOwnersForKeyArgs Empty = new GetPiiSmOwnersForKeyArgs();
    ...
    private GetPiiSmOwnersForKeyArgs() {}

    private GetPiiSmOwnersForKeyArgs(GetPiiSmOwnersForKeyArgs $) {
    ...
    public static Builder builder(GetPiiSmOwnersForKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPiiSmOwnersForKeyArgs();
        }

        public Builder(GetPiiSmOwnersForKeyArgs defaults) {
            $ = new GetPiiSmOwnersForKeyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPiiSmOwnersForKeyArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("GetPiiSmOwnersForKeyArgs", "networkId");
            }
            return $;
        }
    }
