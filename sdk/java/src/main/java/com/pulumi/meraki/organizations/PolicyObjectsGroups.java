...
public class PolicyObjectsGroups extends com.pulumi.resources.CustomResource {
     ...
     */
    public PolicyObjectsGroups(java.lang.String name) {
     ...
     */
    public PolicyObjectsGroups(java.lang.String name, PolicyObjectsGroupsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PolicyObjectsGroups(java.lang.String name, PolicyObjectsGroupsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:organizations/policyObjectsGroups:PolicyObjectsGroups", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PolicyObjectsGroups(java.lang.String name, Output<java.lang.String> id, @Nullable PolicyObjectsGroupsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:organizations/policyObjectsGroups:PolicyObjectsGroups", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static PolicyObjectsGroups get(java.lang.String name, Output<java.lang.String> id, @Nullable PolicyObjectsGroupsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
