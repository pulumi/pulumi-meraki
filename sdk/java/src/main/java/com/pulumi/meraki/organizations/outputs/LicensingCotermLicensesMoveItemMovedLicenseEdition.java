...
@CustomType
public final class LicensingCotermLicensesMoveItemMovedLicenseEdition {
    /**
    ...
    public static Builder builder(LicensingCotermLicensesMoveItemMovedLicenseEdition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String productType;
        public Builder() {}
        public Builder(LicensingCotermLicensesMoveItemMovedLicenseEdition defaults) {
        ...
        public LicensingCotermLicensesMoveItemMovedLicenseEdition build() {
            final var _resultValue = new LicensingCotermLicensesMoveItemMovedLicenseEdition();
