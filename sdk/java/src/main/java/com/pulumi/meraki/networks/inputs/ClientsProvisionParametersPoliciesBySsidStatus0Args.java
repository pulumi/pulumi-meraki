...
public final class ClientsProvisionParametersPoliciesBySsidStatus0Args extends com.pulumi.resources.ResourceArgs {

    public static final ClientsProvisionParametersPoliciesBySsidStatus0Args Empty = new ClientsProvisionParametersPoliciesBySsidStatus0Args();
    ...
    private ClientsProvisionParametersPoliciesBySsidStatus0Args() {}

    private ClientsProvisionParametersPoliciesBySsidStatus0Args(ClientsProvisionParametersPoliciesBySsidStatus0Args $) {
    ...
    public static Builder builder(ClientsProvisionParametersPoliciesBySsidStatus0Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus0Args();
        }

        public Builder(ClientsProvisionParametersPoliciesBySsidStatus0Args defaults) {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus0Args(Objects.requireNonNull(defaults));
        }
        ...
        public ClientsProvisionParametersPoliciesBySsidStatus0Args build() {
            return $;
        }
    }
