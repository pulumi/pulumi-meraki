...
@CustomType
public final class GetManagementInterfaceItemWan2 {
    /**
    ...
    private GetManagementInterfaceItemWan2() {}
    /**
     * @return Up to two DNS IPs.
     * 
     */
    ...
    public static Builder builder(GetManagementInterfaceItemWan2 defaults) {
    ...
    public static final class Builder {
        ...
        private String wanEnabled;
        public Builder() {}
        public Builder(GetManagementInterfaceItemWan2 defaults) {
        ...
        public Builder staticDns(List<String> staticDns) {
            if (staticDns == null) {
              throw new MissingRequiredPropertyException("GetManagementInterfaceItemWan2", "staticDns");
            }
        ...
        public Builder staticGatewayIp(String staticGatewayIp) {
            if (staticGatewayIp == null) {
              throw new MissingRequiredPropertyException("GetManagementInterfaceItemWan2", "staticGatewayIp");
            }
        ...
        public Builder staticIp(String staticIp) {
            if (staticIp == null) {
              throw new MissingRequiredPropertyException("GetManagementInterfaceItemWan2", "staticIp");
            }
        ...
        public Builder staticSubnetMask(String staticSubnetMask) {
            if (staticSubnetMask == null) {
              throw new MissingRequiredPropertyException("GetManagementInterfaceItemWan2", "staticSubnetMask");
            }
        ...
        public Builder usingStaticIp(Boolean usingStaticIp) {
            if (usingStaticIp == null) {
              throw new MissingRequiredPropertyException("GetManagementInterfaceItemWan2", "usingStaticIp");
            }
        ...
        public Builder vlan(Integer vlan) {
            if (vlan == null) {
              throw new MissingRequiredPropertyException("GetManagementInterfaceItemWan2", "vlan");
            }
            this.vlan = vlan;
            return this;
        }
        ...
        public Builder wanEnabled(String wanEnabled) {
            if (wanEnabled == null) {
              throw new MissingRequiredPropertyException("GetManagementInterfaceItemWan2", "wanEnabled");
            }
            this.wanEnabled = wanEnabled;
            return this;
        }
        public GetManagementInterfaceItemWan2 build() {
            final var _resultValue = new GetManagementInterfaceItemWan2();
