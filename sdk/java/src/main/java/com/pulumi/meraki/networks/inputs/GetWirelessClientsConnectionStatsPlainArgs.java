...
public final class GetWirelessClientsConnectionStatsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetWirelessClientsConnectionStatsPlainArgs Empty = new GetWirelessClientsConnectionStatsPlainArgs();
    ...
    private GetWirelessClientsConnectionStatsPlainArgs() {}

    private GetWirelessClientsConnectionStatsPlainArgs(GetWirelessClientsConnectionStatsPlainArgs $) {
        this.apTag = $.apTag;
        this.band = $.band;
    ...
    public static Builder builder(GetWirelessClientsConnectionStatsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetWirelessClientsConnectionStatsPlainArgs();
        }

        public Builder(GetWirelessClientsConnectionStatsPlainArgs defaults) {
            $ = new GetWirelessClientsConnectionStatsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetWirelessClientsConnectionStatsPlainArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("GetWirelessClientsConnectionStatsPlainArgs", "clientId");
            }
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("GetWirelessClientsConnectionStatsPlainArgs", "networkId");
            }
            return $;
        }
    }
