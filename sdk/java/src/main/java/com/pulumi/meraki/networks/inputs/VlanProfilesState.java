...
public final class VlanProfilesState extends com.pulumi.resources.ResourceArgs {

    public static final VlanProfilesState Empty = new VlanProfilesState();
    ...
    private VlanProfilesState() {}

    private VlanProfilesState(VlanProfilesState $) {
        this.iname = $.iname;
    ...
    public static Builder builder(VlanProfilesState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VlanProfilesState();
        }

        public Builder(VlanProfilesState defaults) {
            $ = new VlanProfilesState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param isDefault Boolean indicating the default VLAN Profile for any device that does not have a profile explicitly assigned
         * 
         * @return builder
         * 
         */
        ...
        public VlanProfilesState build() {
            return $;
        }
    }
