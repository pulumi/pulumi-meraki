...
public final class GetWirelessLatencyStatsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetWirelessLatencyStatsPlainArgs Empty = new GetWirelessLatencyStatsPlainArgs();
    ...
    private GetWirelessLatencyStatsPlainArgs() {}

    private GetWirelessLatencyStatsPlainArgs(GetWirelessLatencyStatsPlainArgs $) {
        this.apTag = $.apTag;
        this.band = $.band;
        this.fields = $.fields;
    ...
    public static Builder builder(GetWirelessLatencyStatsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetWirelessLatencyStatsPlainArgs();
        }

        public Builder(GetWirelessLatencyStatsPlainArgs defaults) {
            $ = new GetWirelessLatencyStatsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetWirelessLatencyStatsPlainArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("GetWirelessLatencyStatsPlainArgs", "networkId");
            }
            return $;
        }
    }
