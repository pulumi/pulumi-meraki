...
public class SmDevicesModifyTags extends com.pulumi.resources.CustomResource {
     ...
     */
    public SmDevicesModifyTags(String name) {
     ...
     */
    public static SmDevicesModifyTags get(String name, Output<String> id, @Nullable SmDevicesModifyTagsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
