...
public final class ApplianceRfProfilesPerSsidSettingsStatus4Args extends com.pulumi.resources.ResourceArgs {

    public static final ApplianceRfProfilesPerSsidSettingsStatus4Args Empty = new ApplianceRfProfilesPerSsidSettingsStatus4Args();
    ...
    private ApplianceRfProfilesPerSsidSettingsStatus4Args() {}

    private ApplianceRfProfilesPerSsidSettingsStatus4Args(ApplianceRfProfilesPerSsidSettingsStatus4Args $) {
    ...
    public static Builder builder(ApplianceRfProfilesPerSsidSettingsStatus4Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplianceRfProfilesPerSsidSettingsStatus4Args();
        }

        public Builder(ApplianceRfProfilesPerSsidSettingsStatus4Args defaults) {
            $ = new ApplianceRfProfilesPerSsidSettingsStatus4Args(Objects.requireNonNull(defaults));
        }
        ...
        public ApplianceRfProfilesPerSsidSettingsStatus4Args build() {
            return $;
        }
    }
