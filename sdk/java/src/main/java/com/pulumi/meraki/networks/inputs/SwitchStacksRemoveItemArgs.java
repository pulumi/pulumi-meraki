...
public final class SwitchStacksRemoveItemArgs extends com.pulumi.resources.ResourceArgs {

    public static final SwitchStacksRemoveItemArgs Empty = new SwitchStacksRemoveItemArgs();
    ...
    private SwitchStacksRemoveItemArgs() {}

    private SwitchStacksRemoveItemArgs(SwitchStacksRemoveItemArgs $) {
        this.id = $.id;
        this.name = $.name;
    ...
    public static Builder builder(SwitchStacksRemoveItemArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SwitchStacksRemoveItemArgs();
        }

        public Builder(SwitchStacksRemoveItemArgs defaults) {
            $ = new SwitchStacksRemoveItemArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SwitchStacksRemoveItemArgs build() {
            return $;
        }
    }
