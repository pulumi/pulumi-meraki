...
import com.pulumi.meraki.networks.outputs.GetApplianceTrafficShapingRulesItem;
...
public final class GetApplianceTrafficShapingRulesResult {
    ...
    public static Builder builder(GetApplianceTrafficShapingRulesResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder item(GetApplianceTrafficShapingRulesItem item) {
            if (item == null) {
              throw new MissingRequiredPropertyException("GetApplianceTrafficShapingRulesResult", "item");
            }
            this.item = item;
            return this;
        }
        ...
        public Builder networkId(String networkId) {
            if (networkId == null) {
              throw new MissingRequiredPropertyException("GetApplianceTrafficShapingRulesResult", "networkId");
            }
