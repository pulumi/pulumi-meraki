...
public final class WirelessBillingState extends com.pulumi.resources.ResourceArgs {

    public static final WirelessBillingState Empty = new WirelessBillingState();
    ...
    private WirelessBillingState() {}

    private WirelessBillingState(WirelessBillingState $) {
    ...
    public static Builder builder(WirelessBillingState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessBillingState();
        }

        public Builder(WirelessBillingState defaults) {
            $ = new WirelessBillingState(Objects.requireNonNull(defaults));
        }
        ...
        public WirelessBillingState build() {
            return $;
        }
    }
