...
public final class SensorAlertsProfilesConditionsResponseThresholdHumidityArgs extends com.pulumi.resources.ResourceArgs {

    public static final SensorAlertsProfilesConditionsResponseThresholdHumidityArgs Empty = new SensorAlertsProfilesConditionsResponseThresholdHumidityArgs();
    ...
    private SensorAlertsProfilesConditionsResponseThresholdHumidityArgs() {}

    private SensorAlertsProfilesConditionsResponseThresholdHumidityArgs(SensorAlertsProfilesConditionsResponseThresholdHumidityArgs $) {
    ...
    public static Builder builder(SensorAlertsProfilesConditionsResponseThresholdHumidityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SensorAlertsProfilesConditionsResponseThresholdHumidityArgs();
        }

        public Builder(SensorAlertsProfilesConditionsResponseThresholdHumidityArgs defaults) {
            $ = new SensorAlertsProfilesConditionsResponseThresholdHumidityArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SensorAlertsProfilesConditionsResponseThresholdHumidityArgs build() {
            return $;
        }
    }
