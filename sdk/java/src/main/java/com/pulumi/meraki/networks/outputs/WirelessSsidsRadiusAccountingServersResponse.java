...
@CustomType
public final class WirelessSsidsRadiusAccountingServersResponse {
    /**
    ...
    public static Builder builder(WirelessSsidsRadiusAccountingServersResponse defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String secret;
        public Builder() {}
        public Builder(WirelessSsidsRadiusAccountingServersResponse defaults) {
        ...
        public WirelessSsidsRadiusAccountingServersResponse build() {
            final var _resultValue = new WirelessSsidsRadiusAccountingServersResponse();
