...
@CustomType
public final class FloorPlansTopLeftCorner {
    /**
     * @return Latitude
     * 
     */
    ...
    private FloorPlansTopLeftCorner() {}
    /**
     * @return Latitude
     * 
     */
    ...
    public static Builder builder(FloorPlansTopLeftCorner defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double lng;
        public Builder() {}
        public Builder(FloorPlansTopLeftCorner defaults) {
        ...
        public FloorPlansTopLeftCorner build() {
            final var _resultValue = new FloorPlansTopLeftCorner();
