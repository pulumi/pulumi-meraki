...
public class ApplianceVpnBgp extends com.pulumi.resources.CustomResource {
     ...
     */
    public ApplianceVpnBgp(java.lang.String name) {
     ...
     */
    public ApplianceVpnBgp(java.lang.String name, ApplianceVpnBgpArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ApplianceVpnBgp(java.lang.String name, ApplianceVpnBgpArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/applianceVpnBgp:ApplianceVpnBgp", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ApplianceVpnBgp(java.lang.String name, Output<java.lang.String> id, @Nullable ApplianceVpnBgpState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/applianceVpnBgp:ApplianceVpnBgp", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ApplianceVpnBgp get(java.lang.String name, Output<java.lang.String> id, @Nullable ApplianceVpnBgpState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
