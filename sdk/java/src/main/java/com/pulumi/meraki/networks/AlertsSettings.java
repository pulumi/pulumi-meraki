 ...
 *                 .alert_destinations(Map.ofEntries(
 *                     Map.entry("allAdmins", false),
 *                     Map.entry("emails", List.of("miles}{@literal @}{@code meraki.com")),
 *                     Map.entry("httpServerIds", List.of("aHR0cHM6Ly93d3cuZXhhbXBsZS5jb20vd2ViaG9va3M=")),
 *                     Map.entry("snmp", false)
 *                 ))
 *                 .enabled(true)
 ...
 *                 .http_server_ids(List.of("aHR0cHM6Ly93d3cuZXhhbXBsZS5jb20vd2ViaG9va3M="))
 *                 .snmp(true)
 *                 .build())
 *             .networkId("string")
 *             .build());
