...
import com.pulumi.meraki.organizations.outputs.LicensingCotermLicensesMoveItemMovedLicenseCount;
import com.pulumi.meraki.organizations.outputs.LicensingCotermLicensesMoveItemMovedLicenseEdition;
...
@CustomType
public final class LicensingCotermLicensesMoveItemMovedLicense {
    /**
     ...
     * 
     */
    private @Nullable List<LicensingCotermLicensesMoveItemMovedLicenseCount> counts;
    /**
     ...
     * 
     */
    private @Nullable List<LicensingCotermLicensesMoveItemMovedLicenseEdition> editions;
    /**
     ...
     * 
     */
    public List<LicensingCotermLicensesMoveItemMovedLicenseCount> counts() {
     ...
     * 
     */
    public List<LicensingCotermLicensesMoveItemMovedLicenseEdition> editions() {
    ...
    public static Builder builder(LicensingCotermLicensesMoveItemMovedLicense defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String startedAt;
        public Builder() {}
        public Builder(LicensingCotermLicensesMoveItemMovedLicense defaults) {
        ...
        @CustomType.Setter
        public Builder counts(@Nullable List<LicensingCotermLicensesMoveItemMovedLicenseCount> counts) {

            this.counts = counts;
            return this;
        }
        public Builder counts(LicensingCotermLicensesMoveItemMovedLicenseCount... counts) {
        ...
        @CustomType.Setter
        public Builder editions(@Nullable List<LicensingCotermLicensesMoveItemMovedLicenseEdition> editions) {

            this.editions = editions;
            return this;
        }
        public Builder editions(LicensingCotermLicensesMoveItemMovedLicenseEdition... editions) {
        ...
        public LicensingCotermLicensesMoveItemMovedLicense build() {
            final var _resultValue = new LicensingCotermLicensesMoveItemMovedLicense();
