...
public final class WirelessRfProfilesPerSsidSettingsStatus0Args extends com.pulumi.resources.ResourceArgs {

    public static final WirelessRfProfilesPerSsidSettingsStatus0Args Empty = new WirelessRfProfilesPerSsidSettingsStatus0Args();
     ...
     */
    @Import(name="bands")
    private @Nullable Output<WirelessRfProfilesPerSsidSettingsStatus0BandsArgs> bands;

    /**
     * @return Settings related to all bands
     * 
     */
    public Optional<Output<WirelessRfProfilesPerSsidSettingsStatus0BandsArgs>> bands() {
    ...
    private WirelessRfProfilesPerSsidSettingsStatus0Args() {}

    private WirelessRfProfilesPerSsidSettingsStatus0Args(WirelessRfProfilesPerSsidSettingsStatus0Args $) {
    ...
    public static Builder builder(WirelessRfProfilesPerSsidSettingsStatus0Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessRfProfilesPerSsidSettingsStatus0Args();
        }

        public Builder(WirelessRfProfilesPerSsidSettingsStatus0Args defaults) {
            $ = new WirelessRfProfilesPerSsidSettingsStatus0Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder bands(@Nullable Output<WirelessRfProfilesPerSsidSettingsStatus0BandsArgs> bands) {
            $.bands = bands;
            return this;
        }
         ...
         * 
         */
        public Builder bands(WirelessRfProfilesPerSsidSettingsStatus0BandsArgs bands) {
        ...
        public WirelessRfProfilesPerSsidSettingsStatus0Args build() {
            return $;
        }
    }
