...
@CustomType
public final class GroupPoliciesSchedulingSaturday {
    /**
    ...
    private GroupPoliciesSchedulingSaturday() {}
    /**
     * @return Whether the schedule is active (true) or inactive (false) during the time specified between &#39;from&#39; and &#39;to&#39;. Defaults to true.
     * 
     */
    ...
    public static Builder builder(GroupPoliciesSchedulingSaturday defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String to;
        public Builder() {}
        public Builder(GroupPoliciesSchedulingSaturday defaults) {
        ...
        public GroupPoliciesSchedulingSaturday build() {
            final var _resultValue = new GroupPoliciesSchedulingSaturday();
