...
public class WirelessBluetoothSettings extends com.pulumi.resources.CustomResource {
    ...
    public WirelessBluetoothSettings(java.lang.String name, WirelessBluetoothSettingsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:devices/wirelessBluetoothSettings:WirelessBluetoothSettings", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private WirelessBluetoothSettings(java.lang.String name, Output<java.lang.String> id, @Nullable WirelessBluetoothSettingsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:devices/wirelessBluetoothSettings:WirelessBluetoothSettings", name, state, makeResourceOptions(options, id), false);
    }
