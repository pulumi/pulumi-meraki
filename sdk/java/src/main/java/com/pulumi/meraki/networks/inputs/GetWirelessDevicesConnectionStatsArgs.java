...
public final class GetWirelessDevicesConnectionStatsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetWirelessDevicesConnectionStatsArgs Empty = new GetWirelessDevicesConnectionStatsArgs();
    ...
    private GetWirelessDevicesConnectionStatsArgs() {}

    private GetWirelessDevicesConnectionStatsArgs(GetWirelessDevicesConnectionStatsArgs $) {
        this.apTag = $.apTag;
        this.band = $.band;
    ...
    public static Builder builder(GetWirelessDevicesConnectionStatsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetWirelessDevicesConnectionStatsArgs();
        }

        public Builder(GetWirelessDevicesConnectionStatsArgs defaults) {
            $ = new GetWirelessDevicesConnectionStatsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetWirelessDevicesConnectionStatsArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("GetWirelessDevicesConnectionStatsArgs", "networkId");
            }
            return $;
        }
    }
