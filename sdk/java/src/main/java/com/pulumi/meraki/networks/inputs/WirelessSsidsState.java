...
public final class WirelessSsidsState extends com.pulumi.resources.ResourceArgs {

    public static final WirelessSsidsState Empty = new WirelessSsidsState();
    ...
    @Import(name="adminSplashUrl")
    private @Nullable Output<String> adminSplashUrl;

    public Optional<Output<String>> adminSplashUrl() {
        return Optional.ofNullable(this.adminSplashUrl);
    }
    ...
    private @Nullable Output<List<WirelessSsidsRadiusServersResponseArgs>> radiusServersResponses;

    /**
     * @return The RADIUS 802.1X servers to be used for authentication. This param is only valid if the authMode is &#39;open-with-radius&#39;, &#39;8021x-radius&#39; or &#39;ipsk-with-radius&#39;
     * 
     */
    public Optional<Output<List<WirelessSsidsRadiusServersResponseArgs>>> radiusServersResponses() {
    ...
    private @Nullable Output<String> splashTimeout;

    /**
     * @return Splash page timeout
     * 
     */
    public Optional<Output<String>> splashTimeout() {
     ...
     * 
     */
    @Import(name="ssidAdminAccessible")
    private @Nullable Output<Boolean> ssidAdminAccessible;

    /**
     * @return SSID Administrator access status
     * 
     */
    public Optional<Output<Boolean>> ssidAdminAccessible() {
        return Optional.ofNullable(this.ssidAdminAccessible);
    }
    ...
    private WirelessSsidsState() {}

    private WirelessSsidsState(WirelessSsidsState $) {
    ...
    public static Builder builder(WirelessSsidsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessSsidsState();
        }

        public Builder(WirelessSsidsState defaults) {
            $ = new WirelessSsidsState(Objects.requireNonNull(defaults));
        }
        ...
        public Builder adminSplashUrl(@Nullable Output<String> adminSplashUrl) {
            $.adminSplashUrl = adminSplashUrl;
            return this;
        }

        public Builder adminSplashUrl(String adminSplashUrl) {
            return adminSplashUrl(Output.of(adminSplashUrl));
        }
        ...
        /**
         * @param radiusServersResponses The RADIUS 802.1X servers to be used for authentication. This param is only valid if the authMode is &#39;open-with-radius&#39;, &#39;8021x-radius&#39; or &#39;ipsk-with-radius&#39;
         * 
         * @return builder
         * 
         */
        public Builder radiusServersResponses(@Nullable Output<List<WirelessSsidsRadiusServersResponseArgs>> radiusServersResponses) {
         ...
         * 
         */
        public Builder radiusServersResponses(List<WirelessSsidsRadiusServersResponseArgs> radiusServersResponses) {
         ...
         * 
         */
        public Builder radiusServersResponses(WirelessSsidsRadiusServersResponseArgs... radiusServersResponses) {
        ...
        /**
         * @param splashTimeout Splash page timeout
         * 
         * @return builder
         * 
         */
        public Builder splashTimeout(@Nullable Output<String> splashTimeout) {
        ...
        /**
         * @param ssidAdminAccessible SSID Administrator access status
         * 
         * @return builder
         * 
         */
        public Builder ssidAdminAccessible(@Nullable Output<Boolean> ssidAdminAccessible) {
        ...
        public Builder ssidAdminAccessible(Boolean ssidAdminAccessible) {
            return ssidAdminAccessible(Output.of(ssidAdminAccessible));
        }
        ...
        public WirelessSsidsState build() {
            return $;
        }
    }
