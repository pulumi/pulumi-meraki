...
public class CameraVideoSettings extends com.pulumi.resources.CustomResource {
     ...
     */
    public CameraVideoSettings(java.lang.String name) {
     ...
     */
    public CameraVideoSettings(java.lang.String name, CameraVideoSettingsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CameraVideoSettings(java.lang.String name, CameraVideoSettingsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:devices/cameraVideoSettings:CameraVideoSettings", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CameraVideoSettings(java.lang.String name, Output<java.lang.String> id, @Nullable CameraVideoSettingsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:devices/cameraVideoSettings:CameraVideoSettings", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static CameraVideoSettings get(java.lang.String name, Output<java.lang.String> id, @Nullable CameraVideoSettingsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
