...
public final class GetSensorAlertsOverviewByMetricArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSensorAlertsOverviewByMetricArgs Empty = new GetSensorAlertsOverviewByMetricArgs();
    ...
    private GetSensorAlertsOverviewByMetricArgs() {}

    private GetSensorAlertsOverviewByMetricArgs(GetSensorAlertsOverviewByMetricArgs $) {
    ...
    public static Builder builder(GetSensorAlertsOverviewByMetricArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSensorAlertsOverviewByMetricArgs();
        }

        public Builder(GetSensorAlertsOverviewByMetricArgs defaults) {
            $ = new GetSensorAlertsOverviewByMetricArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSensorAlertsOverviewByMetricArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("GetSensorAlertsOverviewByMetricArgs", "networkId");
            }
            return $;
        }
    }
