...
public final class WirelessRfProfilesPerSsidSettingsStatus12Args extends com.pulumi.resources.ResourceArgs {

    public static final WirelessRfProfilesPerSsidSettingsStatus12Args Empty = new WirelessRfProfilesPerSsidSettingsStatus12Args();
     ...
     */
    @Import(name="bands")
    private @Nullable Output<WirelessRfProfilesPerSsidSettingsStatus12BandsArgs> bands;

    /**
     * @return Settings related to all bands
     * 
     */
    public Optional<Output<WirelessRfProfilesPerSsidSettingsStatus12BandsArgs>> bands() {
    ...
    private WirelessRfProfilesPerSsidSettingsStatus12Args() {}

    private WirelessRfProfilesPerSsidSettingsStatus12Args(WirelessRfProfilesPerSsidSettingsStatus12Args $) {
    ...
    public static Builder builder(WirelessRfProfilesPerSsidSettingsStatus12Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessRfProfilesPerSsidSettingsStatus12Args();
        }

        public Builder(WirelessRfProfilesPerSsidSettingsStatus12Args defaults) {
            $ = new WirelessRfProfilesPerSsidSettingsStatus12Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder bands(@Nullable Output<WirelessRfProfilesPerSsidSettingsStatus12BandsArgs> bands) {
            $.bands = bands;
            return this;
        }
         ...
         * 
         */
        public Builder bands(WirelessRfProfilesPerSsidSettingsStatus12BandsArgs bands) {
        ...
        public WirelessRfProfilesPerSsidSettingsStatus12Args build() {
            return $;
        }
    }
