...
public final class WirelessRfProfilesPerSsidSettingsStatus6Args extends com.pulumi.resources.ResourceArgs {

    public static final WirelessRfProfilesPerSsidSettingsStatus6Args Empty = new WirelessRfProfilesPerSsidSettingsStatus6Args();
     ...
     */
    @Import(name="bands")
    private @Nullable Output<WirelessRfProfilesPerSsidSettingsStatus6BandsArgs> bands;

    /**
     * @return Settings related to all bands
     * 
     */
    public Optional<Output<WirelessRfProfilesPerSsidSettingsStatus6BandsArgs>> bands() {
    ...
    private WirelessRfProfilesPerSsidSettingsStatus6Args() {}

    private WirelessRfProfilesPerSsidSettingsStatus6Args(WirelessRfProfilesPerSsidSettingsStatus6Args $) {
    ...
    public static Builder builder(WirelessRfProfilesPerSsidSettingsStatus6Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessRfProfilesPerSsidSettingsStatus6Args();
        }

        public Builder(WirelessRfProfilesPerSsidSettingsStatus6Args defaults) {
            $ = new WirelessRfProfilesPerSsidSettingsStatus6Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder bands(@Nullable Output<WirelessRfProfilesPerSsidSettingsStatus6BandsArgs> bands) {
            $.bands = bands;
            return this;
        }
         ...
         * 
         */
        public Builder bands(WirelessRfProfilesPerSsidSettingsStatus6BandsArgs bands) {
        ...
        public WirelessRfProfilesPerSsidSettingsStatus6Args build() {
            return $;
        }
    }
