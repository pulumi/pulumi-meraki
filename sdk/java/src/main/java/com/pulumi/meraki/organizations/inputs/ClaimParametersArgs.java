...
public final class ClaimParametersArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClaimParametersArgs Empty = new ClaimParametersArgs();
    ...
    private @Nullable Output<List<ClaimParametersLicenseArgs>> licenses;

    /**
     * @return The licenses that should be claimed
     * 
     */
    public Optional<Output<List<ClaimParametersLicenseArgs>>> licenses() {
    ...
    private ClaimParametersArgs() {}

    private ClaimParametersArgs(ClaimParametersArgs $) {
    ...
    public static Builder builder(ClaimParametersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClaimParametersArgs();
        }

        public Builder(ClaimParametersArgs defaults) {
            $ = new ClaimParametersArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder licenses(@Nullable Output<List<ClaimParametersLicenseArgs>> licenses) {
            $.licenses = licenses;
            return this;
        }
         ...
         * 
         */
        public Builder licenses(List<ClaimParametersLicenseArgs> licenses) {
         ...
         * 
         */
        public Builder licenses(ClaimParametersLicenseArgs... licenses) {
        ...
        public ClaimParametersArgs build() {
            return $;
        }
    }
