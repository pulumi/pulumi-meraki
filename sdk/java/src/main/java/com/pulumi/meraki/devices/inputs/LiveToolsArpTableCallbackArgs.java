...
import com.pulumi.meraki.devices.inputs.LiveToolsArpTableCallbackHttpServerArgs;
import com.pulumi.meraki.devices.inputs.LiveToolsArpTableCallbackPayloadTemplateArgs;
...
public final class LiveToolsArpTableCallbackArgs extends com.pulumi.resources.ResourceArgs {

    public static final LiveToolsArpTableCallbackArgs Empty = new LiveToolsArpTableCallbackArgs();
    ...
    private @Nullable Output<LiveToolsArpTableCallbackHttpServerArgs> httpServer;

    /**
     * @return The webhook receiver used for the callback webhook.
     * 
     */
    public Optional<Output<LiveToolsArpTableCallbackHttpServerArgs>> httpServer() {
    ...
    private @Nullable Output<LiveToolsArpTableCallbackPayloadTemplateArgs> payloadTemplate;

    /**
     * @return The payload template of the webhook used for the callback
     * 
     */
    public Optional<Output<LiveToolsArpTableCallbackPayloadTemplateArgs>> payloadTemplate() {
    ...
    private LiveToolsArpTableCallbackArgs() {}

    private LiveToolsArpTableCallbackArgs(LiveToolsArpTableCallbackArgs $) {
    ...
    public static Builder builder(LiveToolsArpTableCallbackArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LiveToolsArpTableCallbackArgs();
        }

        public Builder(LiveToolsArpTableCallbackArgs defaults) {
            $ = new LiveToolsArpTableCallbackArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder httpServer(@Nullable Output<LiveToolsArpTableCallbackHttpServerArgs> httpServer) {
         ...
         * 
         */
        public Builder httpServer(LiveToolsArpTableCallbackHttpServerArgs httpServer) {
         ...
         * 
         */
        public Builder payloadTemplate(@Nullable Output<LiveToolsArpTableCallbackPayloadTemplateArgs> payloadTemplate) {
         ...
         * 
         */
        public Builder payloadTemplate(LiveToolsArpTableCallbackPayloadTemplateArgs payloadTemplate) {
        ...
        public LiveToolsArpTableCallbackArgs build() {
            return $;
        }
    }
