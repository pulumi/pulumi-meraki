...
@CustomType
public final class ApplianceRfProfilesPerSsidSettingsStatus3 {
    /**
    ...
    private ApplianceRfProfilesPerSsidSettingsStatus3() {}
    /**
     * @return Band mode of this SSID
     * 
     */
    ...
    public static Builder builder(ApplianceRfProfilesPerSsidSettingsStatus3 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean bandSteeringEnabled;
        public Builder() {}
        public Builder(ApplianceRfProfilesPerSsidSettingsStatus3 defaults) {
        ...
        public ApplianceRfProfilesPerSsidSettingsStatus3 build() {
            final var _resultValue = new ApplianceRfProfilesPerSsidSettingsStatus3();
