...
public final class UnbindItem {
    ...
    public static Builder builder(UnbindItem defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String url;
        public Builder() {}
        public Builder(UnbindItem defaults) {
        ...
        public UnbindItem build() {
            final var _resultValue = new UnbindItem();
