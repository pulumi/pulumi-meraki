...
public final class GetClientsBandwidthUsageHistoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetClientsBandwidthUsageHistoryPlainArgs Empty = new GetClientsBandwidthUsageHistoryPlainArgs();
    ...
    private GetClientsBandwidthUsageHistoryPlainArgs() {}

    private GetClientsBandwidthUsageHistoryPlainArgs(GetClientsBandwidthUsageHistoryPlainArgs $) {
    ...
    public static Builder builder(GetClientsBandwidthUsageHistoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetClientsBandwidthUsageHistoryPlainArgs();
        }

        public Builder(GetClientsBandwidthUsageHistoryPlainArgs defaults) {
            $ = new GetClientsBandwidthUsageHistoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetClientsBandwidthUsageHistoryPlainArgs build() {
            if ($.organizationId == null) {
                throw new MissingRequiredPropertyException("GetClientsBandwidthUsageHistoryPlainArgs", "organizationId");
            }
            return $;
        }
    }
