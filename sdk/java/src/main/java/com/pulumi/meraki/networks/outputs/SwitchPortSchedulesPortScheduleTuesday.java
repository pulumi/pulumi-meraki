...
@CustomType
public final class SwitchPortSchedulesPortScheduleTuesday {
    /**
    ...
    private SwitchPortSchedulesPortScheduleTuesday() {}
    /**
     * @return Whether the schedule is active (true) or inactive (false) during the time specified between &#39;from&#39; and &#39;to&#39;. Defaults to true.
     * 
     */
    ...
    public static Builder builder(SwitchPortSchedulesPortScheduleTuesday defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String to;
        public Builder() {}
        public Builder(SwitchPortSchedulesPortScheduleTuesday defaults) {
        ...
        public SwitchPortSchedulesPortScheduleTuesday build() {
            final var _resultValue = new SwitchPortSchedulesPortScheduleTuesday();
