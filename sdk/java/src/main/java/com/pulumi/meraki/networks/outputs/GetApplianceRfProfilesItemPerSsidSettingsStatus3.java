...
@CustomType
public final class GetApplianceRfProfilesItemPerSsidSettingsStatus3 {
    /**
    ...
    private GetApplianceRfProfilesItemPerSsidSettingsStatus3() {}
    /**
     * @return Band mode of this SSID
     * 
     */
    ...
    public static Builder builder(GetApplianceRfProfilesItemPerSsidSettingsStatus3 defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean bandSteeringEnabled;
        public Builder() {}
        public Builder(GetApplianceRfProfilesItemPerSsidSettingsStatus3 defaults) {
        ...
        public Builder bandOperationMode(String bandOperationMode) {
            if (bandOperationMode == null) {
              throw new MissingRequiredPropertyException("GetApplianceRfProfilesItemPerSsidSettingsStatus3", "bandOperationMode");
            }
        ...
        public Builder bandSteeringEnabled(Boolean bandSteeringEnabled) {
            if (bandSteeringEnabled == null) {
              throw new MissingRequiredPropertyException("GetApplianceRfProfilesItemPerSsidSettingsStatus3", "bandSteeringEnabled");
            }
            this.bandSteeringEnabled = bandSteeringEnabled;
            return this;
        }
        public GetApplianceRfProfilesItemPerSsidSettingsStatus3 build() {
            final var _resultValue = new GetApplianceRfProfilesItemPerSsidSettingsStatus3();
