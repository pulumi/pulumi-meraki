...
@CustomType
public final class ApplianceSingleLanIpv6PrefixAssignmentOrigin {
    /**
    ...
    public static Builder builder(ApplianceSingleLanIpv6PrefixAssignmentOrigin defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(ApplianceSingleLanIpv6PrefixAssignmentOrigin defaults) {
        ...
        public ApplianceSingleLanIpv6PrefixAssignmentOrigin build() {
            final var _resultValue = new ApplianceSingleLanIpv6PrefixAssignmentOrigin();
