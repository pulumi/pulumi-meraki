...
public final class ApplianceVlansArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplianceVlansArgs Empty = new ApplianceVlansArgs();
    ...
    private ApplianceVlansArgs() {}

    private ApplianceVlansArgs(ApplianceVlansArgs $) {
    ...
    public static Builder builder(ApplianceVlansArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplianceVlansArgs();
        }

        public Builder(ApplianceVlansArgs defaults) {
            $ = new ApplianceVlansArgs(Objects.requireNonNull(defaults));
        }
