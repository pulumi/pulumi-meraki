...
public final class GetApiRequestsOverviewPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetApiRequestsOverviewPlainArgs Empty = new GetApiRequestsOverviewPlainArgs();
    ...
    private GetApiRequestsOverviewPlainArgs() {}

    private GetApiRequestsOverviewPlainArgs(GetApiRequestsOverviewPlainArgs $) {
    ...
    public static Builder builder(GetApiRequestsOverviewPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetApiRequestsOverviewPlainArgs();
        }

        public Builder(GetApiRequestsOverviewPlainArgs defaults) {
            $ = new GetApiRequestsOverviewPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetApiRequestsOverviewPlainArgs build() {
            if ($.organizationId == null) {
                throw new MissingRequiredPropertyException("GetApiRequestsOverviewPlainArgs", "organizationId");
            }
            return $;
        }
    }
