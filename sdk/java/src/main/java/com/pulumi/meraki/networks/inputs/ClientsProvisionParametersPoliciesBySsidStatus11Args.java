...
public final class ClientsProvisionParametersPoliciesBySsidStatus11Args extends com.pulumi.resources.ResourceArgs {

    public static final ClientsProvisionParametersPoliciesBySsidStatus11Args Empty = new ClientsProvisionParametersPoliciesBySsidStatus11Args();
    ...
    private ClientsProvisionParametersPoliciesBySsidStatus11Args() {}

    private ClientsProvisionParametersPoliciesBySsidStatus11Args(ClientsProvisionParametersPoliciesBySsidStatus11Args $) {
    ...
    public static Builder builder(ClientsProvisionParametersPoliciesBySsidStatus11Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus11Args();
        }

        public Builder(ClientsProvisionParametersPoliciesBySsidStatus11Args defaults) {
            $ = new ClientsProvisionParametersPoliciesBySsidStatus11Args(Objects.requireNonNull(defaults));
        }
        ...
        public ClientsProvisionParametersPoliciesBySsidStatus11Args build() {
            return $;
        }
    }
