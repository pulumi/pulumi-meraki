 ...
 *                 .dns_custom_nameservers(List.of(                
 *                     "8.8.8.8",
 *                     "8.8.4.4"))
 *                 .enabled(true)
 *                 .build())
 ...
 *                     .password("password")
 *                     .build())
 *                 .server_ca_certificate(Map.of("contents", """
 *           "-----BEGIN CERTIFICATE-----
 ...
 *                 .cache_timeout(60)
 *                 .certificate_authentication(Map.ofEntries(
 *                     Map.entry("clientRootCaCertificate", Map.of("contents", """
 *           "-----BEGIN CERTIFICATE-----
 *         MIIDyTCCArGgAwIBAgIKBBNXOVCGU1YztjANBgkqhkiG9w0BAQsFADAnMQ4wDAYD
 *         VQQKEwVDaXNjbzEVMBMGA1UEAxMMQUNUMiBTVURJIENBMB4XDTIxMDUzMTEzNTUx
 *         NVoXDTI5MDUxNDIwMjU0MVowbTEpMCcGA1UEBRMgUElEOkM5MjAwTC0yNFAtNEcg
 ...
 *                     Map.entry("ocspResponderUrl", "http://ocsp-server.example.com"),
 *                     Map.entry("useLdap", false),
 *                     Map.entry("useOcsp", true)
 *                 ))
 *                 .password_authentication(Map.of("enabled", false))
 *                 .build())
 ...
 *                 .allowed_domains(List.of("example.com"))
 *                 .build())
