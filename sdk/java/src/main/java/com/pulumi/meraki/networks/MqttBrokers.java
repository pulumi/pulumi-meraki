...
public class MqttBrokers extends com.pulumi.resources.CustomResource {
     ...
     */
    public MqttBrokers(java.lang.String name) {
     ...
     */
    public MqttBrokers(java.lang.String name, MqttBrokersArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MqttBrokers(java.lang.String name, MqttBrokersArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/mqttBrokers:MqttBrokers", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MqttBrokers(java.lang.String name, Output<java.lang.String> id, @Nullable MqttBrokersState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("meraki:networks/mqttBrokers:MqttBrokers", name, state, makeResourceOptions(options, id), false);
    }

    private static MqttBrokersArgs makeArgs(MqttBrokersArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? MqttBrokersArgs.Empty : args;
    }
     ...
     */
    public static MqttBrokers get(java.lang.String name, Output<java.lang.String> id, @Nullable MqttBrokersState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
