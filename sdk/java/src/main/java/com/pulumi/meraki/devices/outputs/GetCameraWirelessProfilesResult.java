...
import com.pulumi.meraki.devices.outputs.GetCameraWirelessProfilesItem;
...
public final class GetCameraWirelessProfilesResult {
    ...
    public static final class Builder {
        ...
        public Builder serial(String serial) {
            if (serial == null) {
              throw new MissingRequiredPropertyException("GetCameraWirelessProfilesResult", "serial");
            }
            this.serial = serial;
            return this;
        }
