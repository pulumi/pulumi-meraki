...
@CustomType
public final class SwitchPortSchedulesPortScheduleThursday {
    /**
    ...
    private SwitchPortSchedulesPortScheduleThursday() {}
    /**
     * @return Whether the schedule is active (true) or inactive (false) during the time specified between &#39;from&#39; and &#39;to&#39;. Defaults to true.
     * 
     */
    ...
    public static Builder builder(SwitchPortSchedulesPortScheduleThursday defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String to;
        public Builder() {}
        public Builder(SwitchPortSchedulesPortScheduleThursday defaults) {
        ...
        public SwitchPortSchedulesPortScheduleThursday build() {
            final var _resultValue = new SwitchPortSchedulesPortScheduleThursday();
