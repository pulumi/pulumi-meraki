...
public final class WirelessSsidsSplashSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final WirelessSsidsSplashSettingsArgs Empty = new WirelessSsidsSplashSettingsArgs();
    ...
    private WirelessSsidsSplashSettingsArgs() {}

    private WirelessSsidsSplashSettingsArgs(WirelessSsidsSplashSettingsArgs $) {
    ...
    public static Builder builder(WirelessSsidsSplashSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessSsidsSplashSettingsArgs();
        }

        public Builder(WirelessSsidsSplashSettingsArgs defaults) {
            $ = new WirelessSsidsSplashSettingsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WirelessSsidsSplashSettingsArgs build() {
            if ($.networkId == null) {
                throw new MissingRequiredPropertyException("WirelessSsidsSplashSettingsArgs", "networkId");
            }
            if ($.number == null) {
                throw new MissingRequiredPropertyException("WirelessSsidsSplashSettingsArgs", "number");
            }
            return $;
        }
    }
