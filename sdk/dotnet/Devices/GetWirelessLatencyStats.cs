...
namespace Pulumi.Meraki.Devices
{
    public static class GetWirelessLatencyStats
    {
        ...
        public static Task<GetWirelessLatencyStatsResult> InvokeAsync(GetWirelessLatencyStatsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWirelessLatencyStatsResult>("meraki:devices/getWirelessLatencyStats:getWirelessLatencyStats", args ?? new GetWirelessLatencyStatsArgs(), options.WithDefaults());
        ...
        public static Output<GetWirelessLatencyStatsResult> Invoke(GetWirelessLatencyStatsInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetWirelessLatencyStatsResult>("meraki:devices/getWirelessLatencyStats:getWirelessLatencyStats", args ?? new GetWirelessLatencyStatsInvokeArgs(), options.WithDefaults());
