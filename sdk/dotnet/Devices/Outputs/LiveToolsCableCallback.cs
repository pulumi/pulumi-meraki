...
namespace Pulumi.Meraki.Devices.Outputs
{
    ...
    [OutputType]
    public sealed class LiveToolsCableCallback
    {
        /// <summary>
        /// The webhook receiver used for the callback webhook.
        /// </summary>
        public readonly Outputs.LiveToolsCableCallbackHttpServer? HttpServer;
        /// <summary>
        /// The payload template of the webhook used for the callback
        /// </summary>
        public readonly Outputs.LiveToolsCableCallbackPayloadTemplate? PayloadTemplate;
        /// <summary>
        ...
        private LiveToolsCableCallback(
            Outputs.LiveToolsCableCallbackHttpServer? httpServer,

            Outputs.LiveToolsCableCallbackPayloadTemplate? payloadTemplate,
