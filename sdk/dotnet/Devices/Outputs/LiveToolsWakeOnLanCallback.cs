...
namespace Pulumi.Meraki.Devices.Outputs
{
    ...
    [OutputType]
    public sealed class LiveToolsWakeOnLanCallback
    {
        /// <summary>
        /// The webhook receiver used for the callback webhook.
        /// </summary>
        public readonly Outputs.LiveToolsWakeOnLanCallbackHttpServer? HttpServer;
        /// <summary>
        /// The payload template of the webhook used for the callback
        /// </summary>
        public readonly Outputs.LiveToolsWakeOnLanCallbackPayloadTemplate? PayloadTemplate;
        /// <summary>
        ...
        private LiveToolsWakeOnLanCallback(
            Outputs.LiveToolsWakeOnLanCallbackHttpServer? httpServer,

            Outputs.LiveToolsWakeOnLanCallbackPayloadTemplate? payloadTemplate,
