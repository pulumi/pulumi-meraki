...
namespace Pulumi.Meraki.Devices.Outputs
{
    ...
    [OutputType]
    public sealed class LiveToolsThroughputTestCallback
    {
        /// <summary>
        /// The webhook receiver used for the callback webhook.
        /// </summary>
        public readonly Outputs.LiveToolsThroughputTestCallbackHttpServer? HttpServer;
        /// <summary>
        /// The payload template of the webhook used for the callback
        /// </summary>
        public readonly Outputs.LiveToolsThroughputTestCallbackPayloadTemplate? PayloadTemplate;
        /// <summary>
        ...
        private LiveToolsThroughputTestCallback(
            Outputs.LiveToolsThroughputTestCallbackHttpServer? httpServer,

            Outputs.LiveToolsThroughputTestCallbackPayloadTemplate? payloadTemplate,
