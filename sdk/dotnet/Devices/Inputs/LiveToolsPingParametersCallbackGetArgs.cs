...
namespace Pulumi.Meraki.Devices.Inputs
{
    ...
    public sealed class LiveToolsPingParametersCallbackGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The webhook receiver used for the callback webhook.
        /// </summary>
        [Input("httpServer")]
        public Input<Inputs.LiveToolsPingParametersCallbackHttpServerGetArgs>? HttpServer { get; set; }

        /// <summary>
        /// The payload template of the webhook used for the callback
        /// </summary>
        [Input("payloadTemplate")]
        public Input<Inputs.LiveToolsPingParametersCallbackPayloadTemplateGetArgs>? PayloadTemplate { get; set; }
        ...
        public LiveToolsPingParametersCallbackGetArgs()
        {
        }
        public static new LiveToolsPingParametersCallbackGetArgs Empty => new LiveToolsPingParametersCallbackGetArgs();
    }
}
