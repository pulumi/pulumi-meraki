...
namespace Pulumi.Meraki.Devices.Inputs
{
    ...
    public sealed class LiveToolsPingParametersCallbackArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The webhook receiver used for the callback webhook.
        /// </summary>
        [Input("httpServer")]
        public Input<Inputs.LiveToolsPingParametersCallbackHttpServerArgs>? HttpServer { get; set; }

        /// <summary>
        /// The payload template of the webhook used for the callback
        /// </summary>
        [Input("payloadTemplate")]
        public Input<Inputs.LiveToolsPingParametersCallbackPayloadTemplateArgs>? PayloadTemplate { get; set; }
        ...
        public LiveToolsPingParametersCallbackArgs()
        {
        }
        public static new LiveToolsPingParametersCallbackArgs Empty => new LiveToolsPingParametersCallbackArgs();
    }
}
