...
namespace Pulumi.Meraki.Devices.Inputs
{
    ...
    public sealed class LiveToolsCableCallbackGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The webhook receiver used for the callback webhook.
        /// </summary>
        [Input("httpServer")]
        public Input<Inputs.LiveToolsCableCallbackHttpServerGetArgs>? HttpServer { get; set; }

        /// <summary>
        /// The payload template of the webhook used for the callback
        /// </summary>
        [Input("payloadTemplate")]
        public Input<Inputs.LiveToolsCableCallbackPayloadTemplateGetArgs>? PayloadTemplate { get; set; }
        ...
        public LiveToolsCableCallbackGetArgs()
        {
        }
        public static new LiveToolsCableCallbackGetArgs Empty => new LiveToolsCableCallbackGetArgs();
    }
}
