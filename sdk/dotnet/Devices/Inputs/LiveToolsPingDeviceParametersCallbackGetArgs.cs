...
namespace Pulumi.Meraki.Devices.Inputs
{
    ...
    public sealed class LiveToolsPingDeviceParametersCallbackGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The webhook receiver used for the callback webhook.
        /// </summary>
        [Input("httpServer")]
        public Input<Inputs.LiveToolsPingDeviceParametersCallbackHttpServerGetArgs>? HttpServer { get; set; }

        /// <summary>
        /// The payload template of the webhook used for the callback
        /// </summary>
        [Input("payloadTemplate")]
        public Input<Inputs.LiveToolsPingDeviceParametersCallbackPayloadTemplateGetArgs>? PayloadTemplate { get; set; }
        ...
        public LiveToolsPingDeviceParametersCallbackGetArgs()
        {
        }
        public static new LiveToolsPingDeviceParametersCallbackGetArgs Empty => new LiveToolsPingDeviceParametersCallbackGetArgs();
    }
}
