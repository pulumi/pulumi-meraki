...
namespace Pulumi.Meraki.Devices.Inputs
{
    ...
    public sealed class LiveToolsWakeOnLanCallbackGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The webhook receiver used for the callback webhook.
        /// </summary>
        [Input("httpServer")]
        public Input<Inputs.LiveToolsWakeOnLanCallbackHttpServerGetArgs>? HttpServer { get; set; }

        /// <summary>
        /// The payload template of the webhook used for the callback
        /// </summary>
        [Input("payloadTemplate")]
        public Input<Inputs.LiveToolsWakeOnLanCallbackPayloadTemplateGetArgs>? PayloadTemplate { get; set; }
        ...
        public LiveToolsWakeOnLanCallbackGetArgs()
        {
        }
        public static new LiveToolsWakeOnLanCallbackGetArgs Empty => new LiveToolsWakeOnLanCallbackGetArgs();
    }
}
