...
namespace Pulumi.Meraki.Devices.Inputs
{
    ...
    public sealed class LiveToolsThroughputTestCallbackGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The webhook receiver used for the callback webhook.
        /// </summary>
        [Input("httpServer")]
        public Input<Inputs.LiveToolsThroughputTestCallbackHttpServerGetArgs>? HttpServer { get; set; }

        /// <summary>
        /// The payload template of the webhook used for the callback
        /// </summary>
        [Input("payloadTemplate")]
        public Input<Inputs.LiveToolsThroughputTestCallbackPayloadTemplateGetArgs>? PayloadTemplate { get; set; }
        ...
        public LiveToolsThroughputTestCallbackGetArgs()
        {
        }
        public static new LiveToolsThroughputTestCallbackGetArgs Empty => new LiveToolsThroughputTestCallbackGetArgs();
    }
}
