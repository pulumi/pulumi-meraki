...
namespace Pulumi.Meraki.Devices.Inputs
{
    ...
    public sealed class LiveToolsArpTableCallbackArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The webhook receiver used for the callback webhook.
        /// </summary>
        [Input("httpServer")]
        public Input<Inputs.LiveToolsArpTableCallbackHttpServerArgs>? HttpServer { get; set; }

        /// <summary>
        /// The payload template of the webhook used for the callback
        /// </summary>
        [Input("payloadTemplate")]
        public Input<Inputs.LiveToolsArpTableCallbackPayloadTemplateArgs>? PayloadTemplate { get; set; }
        ...
        public LiveToolsArpTableCallbackArgs()
        {
        }
        public static new LiveToolsArpTableCallbackArgs Empty => new LiveToolsArpTableCallbackArgs();
    }
}
