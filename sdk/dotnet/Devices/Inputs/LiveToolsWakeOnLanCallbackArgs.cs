...
namespace Pulumi.Meraki.Devices.Inputs
{
    ...
    public sealed class LiveToolsWakeOnLanCallbackArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The webhook receiver used for the callback webhook.
        /// </summary>
        [Input("httpServer")]
        public Input<Inputs.LiveToolsWakeOnLanCallbackHttpServerArgs>? HttpServer { get; set; }

        /// <summary>
        /// The payload template of the webhook used for the callback
        /// </summary>
        [Input("payloadTemplate")]
        public Input<Inputs.LiveToolsWakeOnLanCallbackPayloadTemplateArgs>? PayloadTemplate { get; set; }
        ...
        public LiveToolsWakeOnLanCallbackArgs()
        {
        }
        public static new LiveToolsWakeOnLanCallbackArgs Empty => new LiveToolsWakeOnLanCallbackArgs();
    }
}
