...
namespace Pulumi.Meraki.Devices.Inputs
{
    ...
    public sealed class LiveToolsArpTableCallbackGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The webhook receiver used for the callback webhook.
        /// </summary>
        [Input("httpServer")]
        public Input<Inputs.LiveToolsArpTableCallbackHttpServerGetArgs>? HttpServer { get; set; }

        /// <summary>
        /// The payload template of the webhook used for the callback
        /// </summary>
        [Input("payloadTemplate")]
        public Input<Inputs.LiveToolsArpTableCallbackPayloadTemplateGetArgs>? PayloadTemplate { get; set; }
        ...
        public LiveToolsArpTableCallbackGetArgs()
        {
        }
        public static new LiveToolsArpTableCallbackGetArgs Empty => new LiveToolsArpTableCallbackGetArgs();
    }
}
