...
namespace Pulumi.Meraki.Devices.Inputs
{
    ...
    public sealed class LiveToolsCableCallbackArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The webhook receiver used for the callback webhook.
        /// </summary>
        [Input("httpServer")]
        public Input<Inputs.LiveToolsCableCallbackHttpServerArgs>? HttpServer { get; set; }

        /// <summary>
        /// The payload template of the webhook used for the callback
        /// </summary>
        [Input("payloadTemplate")]
        public Input<Inputs.LiveToolsCableCallbackPayloadTemplateArgs>? PayloadTemplate { get; set; }
        ...
        public LiveToolsCableCallbackArgs()
        {
        }
        public static new LiveToolsCableCallbackArgs Empty => new LiveToolsCableCallbackArgs();
    }
}
