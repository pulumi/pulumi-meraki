...
namespace Pulumi.Meraki.Organizations.Outputs
{
    ...
    [OutputType]
    public sealed class BaseManagement
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.BaseManagementDetail> Details;

        [OutputConstructor]
        private BaseManagement(ImmutableArray<Outputs.BaseManagementDetail> details)
        {
            Details = details;
        }
    }
