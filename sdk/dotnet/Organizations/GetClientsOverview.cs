...
namespace Pulumi.Meraki.Organizations
{
    public static class GetClientsOverview
    {
        ...
        public static Task<GetClientsOverviewResult> InvokeAsync(GetClientsOverviewArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClientsOverviewResult>("meraki:organizations/getClientsOverview:getClientsOverview", args ?? new GetClientsOverviewArgs(), options.WithDefaults());
