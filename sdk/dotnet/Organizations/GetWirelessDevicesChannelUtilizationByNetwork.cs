...
namespace Pulumi.Meraki.Organizations
{
    public static class GetWirelessDevicesChannelUtilizationByNetwork
    {
        ...
        /// ```
        /// </summary>
        public static Task<GetWirelessDevicesChannelUtilizationByNetworkResult> InvokeAsync(GetWirelessDevicesChannelUtilizationByNetworkArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetWirelessDevicesChannelUtilizationByNetworkResult>("meraki:organizations/getWirelessDevicesChannelUtilizationByNetwork:getWirelessDevicesChannelUtilizationByNetwork", args ?? new GetWirelessDevicesChannelUtilizationByNetworkArgs(), options.WithDefaults());
    ...
    public sealed class GetWirelessDevicesChannelUtilizationByNetworkArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetWirelessDevicesChannelUtilizationByNetworkArgs()
        {
        }
        public static new GetWirelessDevicesChannelUtilizationByNetworkArgs Empty => new GetWirelessDevicesChannelUtilizationByNetworkArgs();
    }

    public sealed class GetWirelessDevicesChannelUtilizationByNetworkInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
        /// </summary>
        ...
        public GetWirelessDevicesChannelUtilizationByNetworkInvokeArgs()
        {
        }
        public static new GetWirelessDevicesChannelUtilizationByNetworkInvokeArgs Empty => new GetWirelessDevicesChannelUtilizationByNetworkInvokeArgs();
    }


    [OutputType]
    public sealed class GetWirelessDevicesChannelUtilizationByNetworkResult
    {
        /// <summary>
        /// endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
        /// </summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetWirelessDevicesChannelUtilizationByNetworkItemResult> Items;
        /// <summary>
        /// networkIds query parameter. Filter results by network.
        /// </summary>
