...
namespace Pulumi.Meraki.Organizations.Inputs
{
    ...
    public sealed class ActionBatchesCallbackGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The webhook receiver used for the callback webhook.
        /// </summary>
        [Input("httpServer")]
        public Input<Inputs.ActionBatchesCallbackHttpServerGetArgs>? HttpServer { get; set; }
        ...
        public Input<Inputs.ActionBatchesCallbackPayloadTemplateGetArgs>? PayloadTemplate { get; set; }
        ...
        public ActionBatchesCallbackGetArgs()
        {
        }
        public static new ActionBatchesCallbackGetArgs Empty => new ActionBatchesCallbackGetArgs();
    }
}
