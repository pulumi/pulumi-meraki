...
namespace Pulumi.Meraki.Networks.Outputs
{
    ...
    [OutputType]
    public sealed class GetWirelessRfProfilesItemApBandSettingsResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetWirelessRfProfilesItemApBandSettingsBandsResult Bands;

        [OutputConstructor]
        private GetWirelessRfProfilesItemApBandSettingsResult(
            string bandOperationMode,

            bool bandSteeringEnabled,

            Outputs.GetWirelessRfProfilesItemApBandSettingsBandsResult bands)
        {
