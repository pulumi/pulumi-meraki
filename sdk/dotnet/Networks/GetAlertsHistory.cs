...
namespace Pulumi.Meraki.Networks
{
    public static class GetAlertsHistory
    {
        ...
        /// ```
        /// </summary>
        public static Task<GetAlertsHistoryResult> InvokeAsync(GetAlertsHistoryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAlertsHistoryResult>("meraki:networks/getAlertsHistory:getAlertsHistory", args ?? new GetAlertsHistoryArgs(), options.WithDefaults());
    ...
    public sealed class GetAlertsHistoryArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetAlertsHistoryArgs()
        {
        }
        public static new GetAlertsHistoryArgs Empty => new GetAlertsHistoryArgs();
    }

    public sealed class GetAlertsHistoryInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
        /// </summary>
        ...
        public GetAlertsHistoryInvokeArgs()
        {
        }
        public static new GetAlertsHistoryInvokeArgs Empty => new GetAlertsHistoryInvokeArgs();
    }


    [OutputType]
    public sealed class GetAlertsHistoryResult
    {
        /// <summary>
        /// endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
        /// </summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetAlertsHistoryItemResult> Items;
        /// <summary>
        /// networkId path parameter. Network ID
        /// </summary>
        ...
        private GetAlertsHistoryResult(
            ...
            ImmutableArray<Outputs.GetAlertsHistoryItemResult> items,
