...
namespace Pulumi.Meraki
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pulumi/pulumi-meraki";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Meraki.version.txt");
    ...
    internal sealed class MerakiResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public MerakiResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
